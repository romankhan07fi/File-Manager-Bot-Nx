...
# ==========================================
TOKEN = "8889132264:AAFGTB9ikI6xLEBTJJemc0hyCjrnZkySE1w"
BASE_URL = f"https://api.telegram.org/bot{TOKEN}"
FILE_URL = f"https://api.telegram.org/file/bot{TOKEN}/"

OWNER_ID = 7603005230
BOT_USERNAME = "@Naruto_Number_Bot"
_BOT_DIR = os.path.dirname(os.path.abspath(__file__))
DB_FILE = os.path.join(_BOT_DIR, "bot_data.json")
USERS_DATA_FILE = os.path.join(_BOT_DIR, "users_data.json")  # Local user storage (no Firestore needed)
...
DEFAULT_CUSTOM_MESSAGES = {
    "start": {"text": f"╭━━━━━━━━━━━━━━━━━━━━╮\n         📊 Profit Zone Number Bot\n╰━━━━━━━━━━━━━━━━━━━━╯\n\n✨ Welcome to Nx Prime!\n🔹 Fast • Secure • Reliable\n\n💎 Choose an Option To Continue.", "buttons": []},
    "get_number": {"text": f"{PEM['pin']} Select Your Service ⤵️ :", "buttons": []},
    "select_country": {"text": f"📌 Select a Country For {{service}} :", "buttons": []}, 
    "search_number": {"text": "╭─────────────────────╮\n          🔍 <b>Search Number</b>\n╰─────────────────────╯\n\n📌 Enter 3 to 9 Digits To Search For a Number.\n─────────────────────\n📝 <b>Example:</b>\n➥ 880\n➥ 9227373\n─────────────────────\n📊 <b>Search Status: Ready</b>\n⚡ Fast & Secure Number Lookup\n─────────────────────\n🔍 Fast Number Lookup System", "buttons": []},
    "traffic": {"text": f"{PEM['graph']} <b>Live Traffic</b>\n\n"
                    f"🥇 <b>Window:</b> Last 30 Minutes\n"
                    f"⏱️ <b>Results Sent:</b> {{results_sent}}\n"
                    f"🏆 <b>Top Country:</b> {{top_country}}\n\n"
                    f"🌍 <b>Top Countries:</b>\n"
                    f"{{top_countries}}\n\n"
                    f"🕐 <b>Last Update:</b> {{last_update}}", "buttons": []},
    "refer": {"text": f"╭━━━━━━━━━━━━━━━━━━━━━━━━━╮\n┃  🎁 Refer & Earn Management System\n┣━━━━━━━━━━━━━━━━━━━━━━━━━┫\n┃  🔗 Your Refer Link :\n┃  <code>{{ref_link}}</code>\n┣━━━━━━━━━━━━━━━━━━━━━━━━━┫\n┃  👥 Total Refers : <b>{{total_ref}}</b>\n┃  💰 Per Refer    : <b>{{ref_reward}} USDT</b>\n╰━━━━━━━━━━━━━━━━━━━━━━━━━╯", "buttons": []}
...
firebase_config ={
  ...
  "project_id": "naruto-zone-bot",
  "private_key_id": "9866baa0418aff990ecd483d7f87ffd9ee640773",
  "private_key": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
  "client_email": "firebase-adminsdk-fbsvc@naruto-zone-bot.iam.gserviceaccount.com",
  "client_id": "103615271888355731058",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40naruto-zone-bot.iam.gserviceaccount.com",
...
bot_settings = {
    "admins": [7603005230],
    # Private admin-only group for OTP event audit logs.
    # Set this to your private group's numeric chat ID (usually starts with -100).
    "private_log_group_id": -1004300562321,
    "panels": [], 
    "fw_groups": [], 
    # Channels that receive the automatic "New Number Added" podcast/broadcast.
    # Maximum 4 targets are managed from ROMAN CONTROL.
    "channel_podcast_targets": [],
    "otp_link": "https://t.me/NxPrimeOTPGroup",
    "main_channel": "https://t.me/NxPrimeofficialUpdate",
    "withdraw_on": True,
    "min_withdraw": 50.0,
    "otp_reward": 0.0,
    "service_otp_rates": {},
    ...
    "num_req": 3,
    "num_share": 1, 
    "support_link": "t.me/roman_khan_admin",
    "w_methods": ["Binance"],
    "w_group": "",
    "w_public_channel": "",  # Approved withdrawals are published here.
    ...
    "flex_panel_on": False,
    "nexus_keys": [],
    "nexus_panel_on": False,
    "nexus_services": {},
    "panel_alert_on": True,
    "user_otp_notify": True,
    "no_match_alert_on": True,
    "user_otp_rates": {},
    "stex_services": {},
    "voltx_services": {},
    "zenex_services": {},
...
FS_KEYS = [
    "admins", "panels", "fw_groups", "channel_podcast_targets", "otp_link", "main_channel", "withdraw_on", 
    "min_withdraw", "otp_reward", "service_otp_rates", "service_reward_enabled", "country_settings", "refer_reward", "cooldown", 
    "num_req", "num_share", "support_link", "w_methods", "w_group",
    "stex_keys", "voltx_keys", "zenex_keys", "shark_tokens", "shark_panel_on", "cr_tokens", "cr_panel_on", "flex_api_url", "flex_tokens", "flex_panel_on", "nexus_keys", "nexus_panel_on", "user_otp_rates",
    "stex_services", "voltx_services", "zenex_services", "nexus_services", "stex_search_countries",
    "fj_on", "fj_channels", "bulk_auto_approve",
    "panel_alert_on", "user_otp_notify", "no_match_alert_on", "rand_name_pass"
]

def get_service_reward(app_full_name, user_id=None, country=None):
    ...
    # 2. Per-country rate (explicit country price wins).
    if country is not None:
        cset = bot_settings.get("country_settings", {}).get(_country_key(country), {})
        if "price" in cset:
            return float(cset.get("price", 0.0)), True
    ...
    if matched_key:
        ...
        # BUG FIX: service rate 0.0 হলে global otp_reward-এ fallback করো
        if amount <= 0 and is_on:
            amount = float(bot_settings.get("otp_reward", 0.0))
        return amount, is_on
...
def service_rates_keyboard():
    ...
    for srv, rate in rates.items():
        ...
        kb.append([
            {"text": f"{srv}: {rate} USDT", "icon_custom_emoji_id": "5190576863226933563", "callback_data": f"dxa_srv_rate_{srv}", "style": "primary"},
    ...
    kb.append([{"text": "𝐀𝐝𝐝 𝐍𝐞𝐰 𝐒𝐞𝐫𝐯𝐢𝐜𝐞", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "dxa_add_srv", "style": "success"}])
    kb.append([{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "dxa_control", "style": "danger"}])
...
def _send_panel_alert(idx, p, msg):
    ...
    if not bot_settings.get("panel_alert_on", True):
        return
    now = time.time()
...
def _try_nexus_key(api_key, range_, service_sid="any"):
    """Single Nexus-X key try — POST /api/v1/numbers থেকে number allocate করে।
    Returns (num_str, number_id, api_key) or (None, None, None)."""
    try:
        headers = {
        ...
        payload = {
            "range": range_,
            "sid": service_sid if service_sid else "any",
            "no_plus": False,
            "national": False
        }
        res = requests.post("https://v2.nexus-x.site/api/v1/numbers", json=payload, headers=headers, timeout=12)
        if res.status_code in (200, 201):
            data = res.json()
            if data.get("ok") or data.get("number"):
                num_raw = data.get("number", "")
                num_str = str(num_raw).replace("+", "").replace(" ", "").replace("-", "").strip()
                number_id = data.get("id", "")
                if num_str and number_id:
                    return (num_str, number_id, api_key)
    except:
        pass
    return (None, None, None)
...
def _fetch_nexus_parallel(range_, service_sid, keys):
    """সব Nexus-X key একসাথে parallel এ try করে, যে আগে success দেয় সেটা নেয়।
    Returns (num_str, number_id, api_key) or (None, None, None)."""
    if not keys:
        return (None, None, None)
    with ThreadPoolExecutor(max_workers=max(1, len(keys))) as ex:
        futures = {ex.submit(_try_nexus_key, k, range_, service_sid): k for k in keys}
...
def load_db():
    global bot_settings, number_batches, used_numbers_list, total_uploaded_stats, total_assigned_stats, recent_traffic, stex_assigned_numbers, voltx_assigned_numbers, zenex_assigned_numbers, nexus_assigned_numbers, batch_assigned_numbers
    ...
    if os.path.exists(DB_FILE):
        try:
            with open(DB_FILE, "r", encoding='utf-8') as f:
                ...
                nexus_assigned_numbers = data.get("nexus_assigned_numbers", {})
...
def save_local_db():
    local_data = {
        ...
        "nexus_assigned_numbers": nexus_assigned_numbers,
...
# Backward compatibility for older bot_data/fs_cache files.
if not isinstance(bot_settings.get("country_settings"), dict):
    bot_settings["country_settings"] = {}

if not isinstance(bot_settings.get("channel_podcast_targets"), list):
    bot_settings["channel_podcast_targets"] = []
else:
    # Keep only the first four configured targets.
    bot_settings["channel_podcast_targets"] = bot_settings["channel_podcast_targets"][:4]
...
# ==========================================
tg_session = requests.Session()  # 🌟 Keep-Alive Connection (Makes bot faster)
...
_PREMIUM_FONT_MAP = str.maketrans('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789', 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789')

_BOLD_ASCII = _PREMIUM_FONT_MAP

_PREMIUM_FONT_PLAIN_MAP = str.maketrans('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789', 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789')

def _bold_button_text(value):
    """Render keyboard labels in the same premium serif-bold font as 𝐆𝐞𝐭 𝐍𝐮𝐦𝐛𝐞𝐫."""
    return str(value).translate(_PREMIUM_FONT_MAP)

def _plain_button_text(value):
    """Normalize premium Unicode labels back to plain text for routing."""
    return unicodedata.normalize("NFKC", str(value)).translate(_PREMIUM_FONT_PLAIN_MAP)

def _premium_visible_text(value):
    """Apply the same premium font to visible text while preserving HTML tags."""
    if value is None:
        return value
    parts = re.split(r'(<[^>]+>)', str(value))
    for i, part in enumerate(parts):
        if not part.startswith('<'):
            parts[i] = part.translate(_PREMIUM_FONT_MAP)
    return ''.join(parts)
...
# Common user-facing phrases. Callback data remains language-neutral.
UI_TRANSLATIONS = {
    "bn": {
        "Please select your language": "অনুগ্রহ করে আপনার ভাষা নির্বাচন করুন",
        "Language": "ভাষা",
        "Get Number": "নম্বর নিন",
        "Leaderboard": "লিডারবোর্ড",
        "Live Traffic": "লাইভ ট্রাফিক",
        "Withdrawal": "উইথড্রয়াল",
        "Support": "সাপোর্ট",
        "Admin Panel": "অ্যাডমিন প্যানেল",
        "Navigation Menu:": "নেভিগেশন মেনু:",
        "Thanks for joining! You can now use the bot.": "চ্যানেলে যোগ দেওয়ার জন্য ধন্যবাদ! এখন আপনি বট ব্যবহার করতে পারবেন।",
        "You haven't joined all channels yet!": "আপনি এখনো সব চ্যানেলে যোগ দেননি!",
        "Please Join Our Channels To Use The Bot!": "বট ব্যবহার করতে আমাদের চ্যানেলগুলোতে যোগ দিন!",
        "Check Joined": "জয়েন চেক করুন",
        "Join Channel": "চ্যানেলে যোগ দিন",
        "Select Your Service ⤵️ :": "আপনার সার্ভিস নির্বাচন করুন ⤵️ :",
        "Select a Country For": "দেশ নির্বাচন করুন",
        "Please enter a valid 3 to 9 digit number!": "অনুগ্রহ করে ৩ থেকে ৯ সংখ্যার একটি সঠিক নম্বর দিন!",
        "Cancel": "বাতিল",
    },
    "ar": {
        "Please select your language": "يرجى اختيار لغتك",
        "Language": "اللغة",
        "Get Number": "الحصول على رقم",
        "Leaderboard": "المتصدرين",
        "Live Traffic": "الحركة المباشرة",
        "Withdrawal": "السحب",
        "Support": "الدعم",
        "Admin Panel": "لوحة الإدارة",
        "Navigation Menu:": "قائمة التنقل:",
        "Thanks for joining! You can now use the bot.": "شكرًا لانضمامك! يمكنك الآن استخدام البوت.",
        "You haven't joined all channels yet!": "لم تنضم إلى جميع القنوات بعد!",
        "Please Join Our Channels To Use The Bot!": "يرجى الانضمام إلى قنواتنا لاستخدام البوت!",
        "Check Joined": "تحقق من الانضمام",
        "Join Channel": "انضم إلى القناة",
        "Select Your Service ⤵️ :": "اختر الخدمة ⤵️ :",
        "Select a Country For": "اختر دولة لـ",
        "Please enter a valid 3 to 9 digit number!": "يرجى إدخال رقم صحيح من 3 إلى 9 أرقام!",
        "Cancel": "إلغاء",
    },
    "id": {
        "Please select your language": "Silakan pilih bahasa Anda",
        "Language": "Bahasa",
        "Get Number": "Ambil Nomor",
        "Leaderboard": "Papan Peringkat",
        "Live Traffic": "Lalu Lintas Langsung",
        "Withdrawal": "Penarikan",
        "Support": "Dukungan",
        "Admin Panel": "Panel Admin",
        "Navigation Menu:": "Menu Navigasi:",
        "Thanks for joining! You can now use the bot.": "Terima kasih sudah bergabung! Sekarang Anda dapat menggunakan bot.",
        "You haven't joined all channels yet!": "Anda belum bergabung dengan semua channel!",
        "Please Join Our Channels To Use The Bot!": "Silakan bergabung dengan channel kami untuk menggunakan bot!",
        "Check Joined": "Cek Bergabung",
        "Join Channel": "Gabung Channel",
        "Select Your Service ⤵️ :": "Pilih layanan Anda ⤵️ :",
        "Select a Country For": "Pilih negara untuk",
        "Please enter a valid 3 to 9 digit number!": "Masukkan nomor 3 hingga 9 digit yang valid!",
        "Cancel": "Batal",
    },
    "hi": {
        ...
        "Live Traffic": "लाइव ट्रैफिक",
        "Withdrawal": "निकासी",
        "Support": "सपोर्ट",
        "Admin Panel": "एडमिन पैनल",
        "Navigation Menu:": "नेविगेशन मेनू:",
        "Thanks for joining! You can now use the bot.": "जॉइन करने के लिए धन्यवाद! अब आप बॉट का उपयोग कर सकते हैं।",
        "You haven't joined all channels yet!": "आपने अभी तक सभी चैनल जॉइन नहीं किए हैं!",
        "Please Join Our Channels To Use The Bot!": "बॉट का उपयोग करने के लिए हमारे चैनल जॉइन करें!",
        "Check Joined": "जॉइन चेक करें",
        "Join Channel": "चैनल जॉइन करें",
        "Select Your Service ⤵️ :": "अपनी सर्विस चुनें ⤵️ :",
        "Select a Country For": "देश चुनें",
        "Please enter a valid 3 to 9 digit number!": "कृपया 3 से 9 अंकों का सही नंबर दर्ज करें!",
        "Cancel": "रद्द करें",
    },
    "ru": {
        ...
        "Live Traffic": "Онлайн-трафик",
        "Withdrawal": "Вывод",
        "Support": "Поддержка",
        "Admin Panel": "Панель администратора",
        "Navigation Menu:": "Меню навигации:",
        "Thanks for joining! You can now use the bot.": "Спасибо за подписку! Теперь вы можете пользоваться ботом.",
        "You haven't joined all channels yet!": "Вы ещё не подписались на все каналы!",
        "Please Join Our Channels To Use The Bot!": "Подпишитесь на наши каналы, чтобы пользоваться ботом!",
        "Check Joined": "Проверить подписку",
        "Join Channel": "Подписаться на канал",
        "Select Your Service ⤵️ :": "Выберите сервис ⤵️ :",
        "Select a Country For": "Выберите страну для",
        "Please enter a valid 3 to 9 digit number!": "Введите корректный номер от 3 до 9 цифр!",
        "Cancel": "Отмена",
    },
}

def get_user_language(user_id):
    """Return saved language code; English is the safe default."""
    try:
        lang = str(get_user(user_id).get("language") or "").lower().strip()
        return lang if lang in SUPPORTED_LANGUAGES else "en"
    except Exception:
        return "en"

def has_selected_language(user_id):
    try:
        return str(get_user(user_id).get("language") or "").lower().strip() in SUPPORTED_LANGUAGES
    except Exception:
        return False
...
def set_user_language(user_id, lang):
    ...
    try:
        ...
        if db:
            ...
            _get_local_user(user_id)["language"] = lang
            _save_users_local()
        return True
    except Exception:
        return False

def translate_ui_text(user_id, text):
    """Translate common UI phrases while preserving HTML/tokens/dynamic data."""
...
def language_keyboard():
    return {"inline_keyboard": [
        [
            ...
            {"text": "🇧🇩 বাংলা", "callback_data": "lang_bn", "style": "primary"},
        ],
        [
            {"text": "🇸🇦 العربية", "callback_data": "lang_ar", "style": "primary"},
            {"text": "🇮🇩 Indonesia", "callback_data": "lang_id", "style": "primary"},
        ],
        [
            {"text": "🇮🇳 हिन्दी", "callback_data": "lang_hi", "style": "primary"},
            {"text": "🇷🇺 Русский", "callback_data": "lang_ru", "style": "primary"},
        ],
    ]}

def send_language_selector(chat_id, edit=False, message_id=None):
    text = "🌐 <b>Please select your language</b>\n\nChoose your preferred language below:"
...
def normalize_localized_command(user_id, text):
    """Map translated reply-keyboard labels back to stable internal commands."""
    raw = _plain_button_text(text or "")
    lang = get_user_language(user_id)
    for canonical, translated in UI_TRANSLATIONS.get(lang, {}).items():
        if raw == _plain_button_text(translated):
            return canonical
    return raw

def localize_reply_markup(chat_id, reply_markup):
    """Translate only known UI button labels; never alter callback_data/URLs."""
    if not isinstance(reply_markup, dict):
        return reply_markup
        ...
        for row in rows:
            ...
            for button in row:
                if isinstance(button, dict):
                    b = dict(button)
                    if "text" in b:
                        b["text"] = tr.get(_plain_button_text(b["text"]), b["text"])
                    new_row.append(b)
                else:
                    new_row.append(button)
            new_rows.append(new_row)
...
def send_message(chat_id, text, reply_markup=None, parse_mode="HTML"):
    text = translate_ui_text(chat_id, text)
    text = _premium_visible_text(text)
    payload = {"chat_id": chat_id, "text": text, "parse_mode": parse_mode, "disable_web_page_preview": True}
    if reply_markup: payload["reply_markup"] = _bold_keyboard_markup(localize_reply_markup(chat_id, reply_markup))
    return api_call("sendMessage", payload)

def send_photo(chat_id, photo_url_or_file_id, caption="", reply_markup=None, parse_mode="HTML"):
    caption = translate_ui_text(chat_id, caption)
    caption = _premium_visible_text(caption)
...
def edit_message_reply_markup(chat_id, message_id, reply_markup):
    ...
    return api_call("editMessageReplyMarkup", {
        ...
        "reply_markup": _bold_keyboard_markup(localize_reply_markup(chat_id, reply_markup)),
    })
...
def answer_callback(callback_id, text="", show_alert=False):
    api_call("answerCallbackQuery", {"callback_query_id": callback_id, "text": _premium_visible_text(text), "show_alert": show_alert})
...
def render_body_text(text):
    ...
    return _premium_visible_text("".join(parts))
...
def mask_num_for_group(num):
    """OTP group-এ masked number:  +2250•••2223"""
    clean = num.replace(" ", "")
...
def mask_number(num):
    clean = num.replace("+", "").replace(" ", "")
    if len(clean) > 6: return f"{clean[:4]}•••{clean[-4:]}"
    elif len(clean) > 2: return f"{clean[:4]}•••{clean[-4:]}"
    return clean
...
def build_otp_inbox(app_full_name, prem_app_html, char, iso, display_num, lang, otp, reward=0, reward_on=False):
    """Build OTP inbox message + keyboard in new design:
       {premium_flag} {ISO_short} {service_logo} {number} #{language}
    ...
    f"╭─────────────────────╮\n"
    f"│{flag_html} #{iso_short} {prem_app_html} {masked_num} #{lang_name}\n"
    f"╰─────────────────────╯"
)
    kb = [
        ...
        [
            {"text": "𝐆𝐞𝐭 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5231012545799666522",
             "url": f"https://t.me/{BOT_USERNAME}", "style": "primary"},
            {"text": "𝐌𝐚𝐢𝐧 𝐂𝐡𝐚𝐧𝐧𝐞𝐥", "icon_custom_emoji_id": "5217822164362739968",
             "url": bot_settings.get("main_channel", "https://t.me/Nr_Crypto_Market07"), "style": "danger"}
        ]
    ]
    if reward > 0 and reward_on:
        kb.append([{"text": f"Added {reward} USDT", "icon_custom_emoji_id": "5420396762189831222",
                    "callback_data": "ignore", "style": "primary"}])
    return msg, kb


def _fw_send_otp(fw_list, app_full_name, prem_app_html, char, iso, display_num, lang, otp):
    """Forward-group OTP card.

    Format:
      Country + premium flag | premium service emoji/name | masked number | language
      [ Channel ] [ OTP / Copy ]
      [ Get Number ]

    This is intentionally separate from the user's private OTP inbox layout.
    """
    try:
        # ---------- Country ----------
        iso_clean = str(iso or "XX").upper().strip()
        country_name = get_country_name(iso_clean)

        # Premium country emoji when configured; otherwise the normal flag.
        flag_html = get_flag_info_html(iso_clean) if iso_clean != "XX" else (char or "🌍")

        # ---------- Service ----------
        # get_service_info_html() already returns a premium custom emoji when the
        # service is configured as premium, and a normal fallback otherwise.
        service_name = str(app_full_name or "OTP Service").strip()
        service_html = prem_app_html or "📱"

        # ---------- Language ----------
        lang_key = str(lang or "").strip()
        lang_name = _LANG_NAMES.get(lang_key)
        if not lang_name:
            # detect_language() may return values such as '#English'.
            lang_name = lang_key.lstrip("#").strip().title() if lang_key else "English"
        if not lang_name:
            lang_name = "English"

        # ---------- Number ----------
        masked_num = mask_num_for_group(str(display_num or ""))

        # Keep the card compact and close to the requested OTV/OTP format.
        grp_msg = render_body_text(
            f"{flag_html} <b>{html.escape(iso_clean)}</b> | "
            f"{service_html} <b>{html.escape(masked_num)}</b> | "
            f"🔊 <b>{html.escape(lang_name)}</b>"
        )

        # ---------- Keyboard ----------
        # Row 1: Channel + OTP code (OTP button copies the code)
        main_channel = str(bot_settings.get("main_channel") or "").strip()
        if not main_channel:
            main_channel = bot_settings.get("otp_link", "https://t.me/")

        bot_username = str(BOT_USERNAME or "").strip().lstrip("@")
        get_number_url = f"https://t.me/{bot_username}" if bot_username else "https://t.me/"

        otp_text = str(otp or "").strip() or "—"
        grp_kb = [
            [
                {
                    "text": "🔔 Channel",
                ...
                {
                    "text": otp_text,
                    "copy_text": {"text": otp_text if otp_text != "—" else ""},
                    "style": "success",
                    "icon_custom_emoji_id": "5251227707026470504",
                },
            ],
            [
                {
        ...
        # ---------- Send to every configured forward group ----------
        for fw in fw_list or []:
            if not isinstance(fw, dict):
                continue
            chat_id = fw.get("chat_id")
            if not chat_id:
                continue
            try:
                # The three-button layout above is the canonical OTV group layout.
                # Admin-configured extra buttons are intentionally not appended here
                # so the forwarded message stays identical across groups.
                send_message(
                    chat_id,
                    grp_msg,
                    reply_markup={"inline_keyboard": grp_kb},
                )
            except Exception as exc:
                # One broken group must never stop OTP delivery to the remaining groups.
                print(f"⚠️ [OTP Forward] group {chat_id} failed: {exc}")

    except Exception as exc:
        # Never let a formatting/metadata problem break the OTP polling thread.
        print(f"⚠️ [OTP Forward] format error: {exc}")

def _send_private_otp_event_log(owner_id, phone_number, iso="", service_html="📱"):
    """Send a compact, non-secret private-group event card.

    The authentication OTP itself is intentionally never included here.
    """
    log_group_id = bot_settings.get("private_log_group_id")
    if not log_group_id:
        return
    ...
    try:
        ...
        chat = data.get("result", {}) if data.get("ok") else {}

        iso_clean = str(iso or "XX").upper().strip() or "XX"
        flag_html = get_flag_info_html(iso_clean) if iso_clean != "XX" else "🌍"
        masked_num = mask_num_for_group(str(phone_number or ""))
        service_icon = service_html or "📱"

        # Clickable Telegram profile link.
        user_link = f"tg://user?id={owner_id}"
        profile_label = f"🗣 {owner_id}"

        # Safe COPY button: copies only the masked number, never the authentication OTP.
        copy_value = masked_num if masked_num and masked_num != "Unknown" else ""
        private_kb = [[{
            "text": "📋 Copy",
        ...
        full_num = str(phone_number or "Unknown")

        log_text = (
            f"{flag_html} <b>{html.escape(iso_clean)}</b> | "
            f"{service_icon} | "
            f"<b>{html.escape(full_num)}</b> | "
            f"<a href=\"{user_link}\">{html.escape(profile_label)}</a>"
        )

        send_message(
            log_group_id,
            render_body_text(log_text),
            reply_markup={"inline_keyboard": private_kb}
        )
    except Exception as e:
        print(f"⚠️ Private OTP event log failed for {owner_id}: {e}")


def _user_send_otp(owner_id, char, iso, prem_app_html, display_num, otp, reward=0, reward_on=False, lang=None):
    """Bot user-কে simple design পাঠায় — আগে group পেত, এখন bot user পাবে."""
    # Private admin-group audit log for every OTP delivery path.
    # The actual OTP value is intentionally never logged.
    _send_private_otp_event_log(owner_id, display_num, iso, prem_app_html)
    if not bot_settings.get("user_otp_notify", True):
        return
    ...
    flag_html = get_flag_info_html(iso) if iso else char
    # User Inbox OTP header: Flag → 2-letter country code → service logo/name → full number → language.
    country_code = str(iso or "XX").strip().upper()
    language = str(lang or "EN").strip().lstrip("#").upper() or "EN"
    service_html = prem_app_html or ""
    simple_msg = render_body_text(f"{flag_html} {country_code} {service_html} {display_num} {language}")
    user_kb = [[{"text": f"{otp}", "icon_custom_emoji_id": "5353022963132174959",
                 "copy_text": {"text": otp}, "style": "success"}]]
    if reward > 0 and reward_on:
        user_kb.append([{"text": f"Added {reward} USDT", "icon_custom_emoji_id": "5420396762189831222",
                         "callback_data": "ignore", "style": "primary"}])
                ...
                try:
                    ...
                    for item in parsed_data:
                        ...
                        if _safe_add_otp(unique_id):  # thread-safe check+add atomically
                            ...
                            for assigned_dict in [batch_assigned_numbers, stex_assigned_numbers, voltx_assigned_numbers, zenex_assigned_numbers, nexus_assigned_numbers]:
                            ...
                            if not owners:
                                ...
                                if bot_settings.get("no_match_alert_on", True):
                                    try:
                                        ...
                                        _dbg_msg = render_body_text(
                                            "╭━━━━━━━━━━━━━━━━━━━━━━╮\n"
                                            "┃  📡 <b>All Panel Agent Account</b>\n"
                                            "╰━━━━━━━━━━━━━━━━━━━━━━╯\n\n"
                                            "⚠️ <b>No User Match Found</b>\n\n"
                                            f"📞 <b>Number:</b> <code>+{clean_api_num}</code>\n"
                                            f"🔑 <b>OTP:</b> <code>{otp}</code>\n"
                                            f"📊 <b>Batch Assigned:</b> {len(batch_assigned_numbers)} | "
                                            f"<b>Sessions:</b> {len(user_active_sessions)}"
                                        )
                            ...
                            for owner_id in owners:
                                try:
                                    reward, reward_on = get_service_reward(app_full_name, owner_id, iso)
                                    if reward > 0 and reward_on:
                                        update_balance(owner_id, reward)
                                    _user_send_otp(owner_id, char, iso, prem_app_html, display_num, otp, reward if reward_on else 0, reward_on, lang=locals().get("lang"))
...
# ==========================================
# User Management — Local JSON + Firestore (optional)
# ==========================================
# Firestore না থাকলে সব user data local users_data.json-এ save হয়।
# RAM cache: 5 মিনিটের TTL, সর্বোচ্চ 200 user।

_user_cache = {}      # {user_id: (data_dict, timestamp)}
_USER_TTL = 300       # 5 মিনিট (seconds)
_USER_CACHE_MAX = 200

# Local (no-Firestore) user store — key: str(user_id)
_local_users: dict = {}

def _load_users_local():
    """Bot start-এ users_data.json থেকে user data লোড করে।"""
    global _local_users
    if os.path.exists(USERS_DATA_FILE):
        try:
            with open(USERS_DATA_FILE, "r", encoding="utf-8") as f:
                _local_users = json.load(f)
            print(f"✅ Local users DB loaded ({len(_local_users)} users)")
        except Exception as e:
...
def _save_users_local():
    """users_data.json-এ user data সেভ করে।"""
    try:
        with open(USERS_DATA_FILE, "w", encoding="utf-8") as f:
            json.dump(_local_users, f, indent=2, ensure_ascii=False)
    except Exception as e:
        print(f"❌ Error saving users_data.json: {e}")

def _get_local_user(user_id):
    """Local store থেকে user dict return করে। না থাকলে নতুন বানায়।"""
    key = str(user_id)
    if key not in _local_users:
        _local_users[key] = {
            "user_id": user_id, "balance": 0.0,
            "total_refers": 0, "total_otps": 0,
            "banned": False, "verified": False, "language": None,
            "referred_by": None, "ref_paid": False
        }
    return _local_users[key]
...
def get_user(user_id):
    """User data ফেরত দেয়। Firestore থাকলে Firestore, না থাকলে local file।"""
    ...
    try:
        ...
        if doc.exists:
            ...
            if "language" not in data: data["language"] = None
            _cache_set(user_id, data)
            return data
        else:
            new_user = {"user_id": user_id, "balance": 0.0, "total_refers": 0,
                        "total_otps": 0, "banned": False, "verified": False, "language": None}
...
def update_balance(user_id, amount):
    """Balance update করে। Firestore না থাকলে local file-এ save করে।"""
    amt = float(amount)
    if not db:
        # ── LOCAL MODE: local file-এ save ──
        data = _get_local_user(user_id)
        data["balance"] = round(data.get("balance", 0.0) + amt, 6)
        _cache_set(user_id, data)
        _save_users_local()
        return
    # ── FIRESTORE MODE ──
    try:
        doc_ref = db.collection('users').document(str(user_id))
        doc_ref.set({"user_id": user_id, "balance": firestore.Increment(amt)}, merge=True)
        # Firestore সফল — cache sync করো
        cached = _cache_get(user_id)
        if cached:
            cached["balance"] = round(cached.get("balance", 0.0) + amt, 6)
            _cache_set(user_id, cached)
        else:
            _user_cache.pop(user_id, None)
    except Exception as e:
        print(f"⚠️ update_balance FAILED for user {user_id}: {e}")

def increment_total_otps(user_id):
    """total_otps বাড়ায়। Firestore না থাকলে local file-এ save করে।"""
    if not db:
        # ── LOCAL MODE ──
        data = _get_local_user(user_id)
        data["total_otps"] = data.get("total_otps", 0) + 1
        _cache_set(user_id, data)
        _save_users_local()
        return
    # ── FIRESTORE MODE ──
    try:
        db.collection('users').document(str(user_id)).update({"total_otps": firestore.Increment(1)})
        cached = _cache_get(user_id)
        if cached:
            cached["total_otps"] = cached.get("total_otps", 0) + 1
            _cache_set(user_id, cached)
    except Exception as e:
        print(f"⚠️ increment_total_otps FAILED for user {user_id}: {e}")

def add_referral(inviter_id, new_user_id):
    """Refer reward দেয়। Firestore বা local file — যেটা available।"""
    get_user(new_user_id)
    reward = bot_settings.get("refer_reward", 0.2)
    update_balance(inviter_id, reward)
    if not db:
        # ── LOCAL MODE ──
        data = _get_local_user(inviter_id)
        data["total_refers"] = data.get("total_refers", 0) + 1
        _cache_set(inviter_id, data)
        _save_users_local()
    else:
        try:
            db.collection('users').document(str(inviter_id)).update({"total_refers": firestore.Increment(1)})
            cached = _cache_get(inviter_id)
            if cached:
                cached["total_refers"] = cached.get("total_refers", 0) + 1
                _cache_set(inviter_id, cached)
        except Exception as e:
            print(f"⚠️ add_referral total_refers FAILED: {e}")
    ref_msg = (
...
def _process_pending_referral(user_id):
    """User এর pending referral reward process করে। Firestore বা local — যেটা available।"""
    if not db:
        # ── LOCAL MODE ──
        data = _get_local_user(user_id)
        inviter = data.get("referred_by")
        if inviter and not data.get("ref_paid"):
            data["ref_paid"] = True
            _cache_set(user_id, data)
            _save_users_local()
            reward = bot_settings.get("refer_reward", 0.2)
            update_balance(inviter, reward)
            inviter_data = _get_local_user(inviter)
            inviter_data["total_refers"] = inviter_data.get("total_refers", 0) + 1
            cached = _cache_get(inviter)
            if cached:
                cached["total_refers"] = inviter_data["total_refers"]
                _cache_set(inviter, cached)
            _save_users_local()
            ref_msg = (
                f"{PEM['gift']} <b>New Referral !</b>\n"
                f"------------------\n"
                f"🔥 <b>You Received {reward} USDT</b>\n"
                f"------------------\n"
                f"{PEM['user']} <b>From User ID:</b> <code>{user_id}</code>"
            )
            try: send_message(inviter, render_body_text(ref_msg))
            except: pass
        return
    # ── FIRESTORE MODE ──
    try:
        ...
        if doc.exists:
            ...
            if u_data.get("referred_by") and not u_data.get("ref_paid"):
                ...
                db.collection('users').document(str(user_id)).update({"ref_paid": True})
                reward = bot_settings.get("refer_reward", 0.2)
                update_balance(inviter, reward)
        ...
        print(f"⚠️ _process_pending_referral failed: {e}")
...
def main_menu(user_id):
    lang = get_user_language(user_id)
    tr = UI_TRANSLATIONS.get(lang, {})
    def L(value): return tr.get(value, value)
    kb = [
        [
            {"text": L("Get Number"), "icon_custom_emoji_id": "5337132498965010628", "style": "primary"}, 
            {"text": L("Leaderboard"), "icon_custom_emoji_id": "5463352748751753567", "style": "primary"}
        ],
        [
            {"text": L("Live Traffic"), "icon_custom_emoji_id": "5420396762189831222", "style": "success"}, 
            {"text": L("Withdrawal"), "icon_custom_emoji_id": "5352585194295564660", "style": "danger"}
        ],
        [
            {"text": L("Support"), "icon_custom_emoji_id": "5420145051336485498", "style": "primary"}
        ]
    ]
    if is_admin(user_id): 
        kb.append([{"text": L("Admin Panel"), "icon_custom_emoji_id": "5420155432272438703", "style": "danger"}])
...
def get_admin_text():
    ...
    txt = f"""
{PEM['admin']} <b>ADMIN CONTROL PANEL X PRO</b> {PEM['admin']}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

{PEM['graph']} <b>DATABASE OVERVIEW X</b>
— — — — — — — — — —  — — —  — — —
{PEM['user']} Total Users   ➤ {users_count}
{PEM['file']} Total Files   ➤ {total_files}
{PEM['num']} Total Numbers  ➤ {total_uploaded_stats}
{PEM['ok']} Total Assigned  ➤ {total_assigned_stats}
{PEM['rocket']} Total Available ➤ {available_nums}

{PEM['graph']} <b>Full Stock Level</b>
— — — — — — — — — —  — — —  — — —
[████████░░░░░░░░░] {available_nums} Free Number
"""
    return render_body_text(txt)

def admin_panel_keyboard():
    return {"inline_keyboard": [
        [{"text": "𝐋𝐞𝐚𝐝𝐞𝐫 𝐁𝐨𝐚𝐫𝐝 𝐒𝐲𝐬𝐭𝐞𝐦", "icon_custom_emoji_id": "5353032893096567467", "callback_data": "lb_main", "style": "success"}],
        [{"text": "𝐔𝐩𝐥𝐨𝐚𝐝 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5353001161878182134", "callback_data": "upload_num", "style": "primary"},
         {"text": "𝐃𝐞𝐥𝐞𝐭𝐞 𝐅𝐢𝐥𝐞𝐬", "icon_custom_emoji_id": "5422557736330106570", "callback_data": "delete_files", "style": "danger"}],
        [{"text": "𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭", "icon_custom_emoji_id": "5789428375261023681", "callback_data": "broadcast_msg", "style": "success"},
         {"text": "𝐒𝐲𝐬𝐭𝐞𝐦", "icon_custom_emoji_id": "5420155432272438703", "callback_data": "system_settings", "style": "primary"}],
        [{"text": "📦 𝐔𝐩𝐝𝐚𝐭𝐞 𝐒𝐭𝐨𝐜𝐤", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "update_stock", "style": "success"}],
        [{"text": "𝐔𝐬𝐞𝐝 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5352694861990501856", "callback_data": "show_used", "style": "success"},
         {"text": "𝐔𝐧𝐮𝐬𝐞𝐝 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5352597830089347330", "callback_data": "show_unused", "style": "success"}],
        [{"text": f"💰 𝐏𝐞𝐧𝐝𝐢𝐧𝐠 𝐖𝐢𝐭𝐡𝐝𝐫𝐚𝐰𝐚𝐥𝐬 ({len(pending_withdrawals)})", "icon_custom_emoji_id": "5190576863226933563", "callback_data": "adm_pending_w", "style": "danger"}],
        [{"text": "𝐂𝐥𝐨𝐬𝐞", "icon_custom_emoji_id": "5420130255174145507", "callback_data": "close_msg", "style": "danger"}]
    ]}

# ==========================================
# UPDATE STOCK / COUNTRY MANAGEMENT
# ==========================================
def _country_key(value):
    """Return one stable ISO-2 key for every country representation."""
    raw = str(value or "").strip()
    if not raw:
        return "XX"
    up = raw.upper()

    # 1) Exact ISO/name match from the configured premium flag database.
    # Never use a loose substring match here because it can map one country
    # to another country with a similar/contained name.
    premium = bot_settings.get("premium_flags", {})
    for _code, _fd in premium.items():
        iso = str(_fd.get("iso", "")).upper().strip()
        name = str(_fd.get("name", "")).upper().strip()
        if iso and up == iso:
            return iso
        if name and up == name and iso:
            return iso

    # 2) Standard country database: full name, ISO-2 and ISO-3 all resolve
    # to the same ISO-2 key.
    if pycountry is not None:
        for lookup_value in (raw, up):
            try:
                ...
                pass
        try:
            country = pycountry.countries.get(alpha_2=up)
            if country:
                return str(country.alpha_2).upper()
        except Exception:
            pass
        try:
            country = pycountry.countries.get(alpha_3=up)
            if country:
                return str(country.alpha_2).upper()
        except Exception:
            pass

    # 3) Do NOT use partial/substring matching here.
    # A code such as "IL" is contained in "BRAZIL"; substring matching can
    # therefore turn Israel (IL) into Brazil (BR). Unknown values are kept
    # unchanged instead of guessing a different country.
    return up


def _country_display(value):
    """Return one consistent full country name for an ISO/name/key input."""
    key = _country_key(value)

    # Prefer the configured premium display name for the exact ISO key.
    for _code, _fd in bot_settings.get("premium_flags", {}).items():
        iso = str(_fd.get("iso", "")).upper().strip()
        name = str(_fd.get("name", "")).strip()
        if iso == key and name:
            return name

    # Otherwise use the standard country database.
    if pycountry is not None:
        try:
    ...
    return str(value or key).strip().title()

def _country_setting(value):
    settings = bot_settings.setdefault("country_settings", {})
    key = _country_key(value)
...
def _country_is_enabled(value):
    setting = bot_settings.get("country_settings", {}).get(_country_key(value), {})
    return bool(setting.get("enabled", True))


def _country_num_req(value):
    setting = bot_settings.get("country_settings", {}).get(_country_key(value), {})
    try:
        return max(1, int(setting["num_req"])) if "num_req" in setting else max(1, int(bot_settings.get("num_req", 1)))
    except Exception:
        return max(1, int(bot_settings.get("num_req", 1)))

def _all_stock_countries():
    # Every UI entry is keyed by the canonical ISO-2 code.  The display name
    # is generated from that same key, so a country can never show another
    # country's name when its callback is opened.
    found = {}
    for b in number_batches.values():
        if b.get("numbers"):
            raw = str(b.get("country", "")).strip()
            if raw:
                key = _country_key(raw)
                found[key] = _country_display(key)
    for map_name in ("stex_services", "voltx_services", "zenex_services", "nexus_services"):
        for _srv, countries in bot_settings.get(map_name, {}).items():
            if isinstance(countries, dict):
                for raw in countries.keys():
                    raw = str(raw).strip()
                    if raw:
                        key = _country_key(raw)
                        found[key] = _country_display(key)
    return dict(sorted(found.items(), key=lambda kv: kv[1].lower()))

def _country_cb_token(key):
    canonical = _country_key(key)
    return base64.urlsafe_b64encode(str(canonical).encode()).decode().rstrip("=")

def _country_from_token(token):
    try:
        decoded = base64.urlsafe_b64decode(token + "=" * (-len(token) % 4)).decode()
    except Exception:
        decoded = str(token or "").strip().upper()
    return _country_key(decoded)

def _country_map_get(country_map, country, default=None):
    """Get a provider country entry using the same canonical ISO-2 country key.
    This prevents country-name/ISO mismatches (e.g. ISRAEL vs IL) from
    selecting the wrong entry or showing a different country's settings.
    """
    if not isinstance(country_map, dict):
        return default
    wanted = _country_key(country)
    if wanted in country_map:
        return country_map[wanted]
    for raw_key, value in country_map.items():
        if _country_key(raw_key) == wanted:
            return value
    return default

# Normalize saved country settings and old local batches only after all country
# helper functions are defined. This prevents country-name/ISO mismatches from
# surviving a restart and keeps every country tied to one canonical ISO-2 key.
try:
    _normalized_country_settings = {}
    for _raw_country, _raw_setting in bot_settings.get("country_settings", {}).items():
        _ckey = _country_key(_raw_country)
        if not isinstance(_raw_setting, dict):
            _raw_setting = {}
        if _ckey not in _normalized_country_settings:
            _normalized_country_settings[_ckey] = dict(_raw_setting)
        else:
            _normalized_country_settings[_ckey].update(_raw_setting)
    bot_settings["country_settings"] = _normalized_country_settings
    for _batch in number_batches.values():
        if isinstance(_batch, dict) and _batch.get("country"):
            _batch["country"] = _country_key(_batch.get("country"))
except Exception as _e:
    print(f"⚠️ Country data normalization skipped: {_e}")

def _country_flag_emoji_id(country):
    key = _country_key(country)
    for _code, fd in bot_settings.get("premium_flags", {}).items():
        if str(fd.get("iso", "")).upper() == key:
            return fd.get("id", "5780471598922337683")
    return "5780471598922337683"

def _country_local_count():
    return sum(len(b.get("numbers", [])) for b in number_batches.values())

def _stock_pair_count():
    pairs = set()
    for b in number_batches.values():
        if b.get("numbers"):
            pairs.add((str(b.get("service", "")).upper().strip(), _country_key(b.get("country"))))
    for map_name in ("stex_services", "voltx_services", "zenex_services", "nexus_services"):
        for service, countries in bot_settings.get(map_name, {}).items():
            if isinstance(countries, dict):
                for country in countries:
                    pairs.add((str(service).upper().strip(), _country_key(country)))
    return len(pairs)

def update_stock_text():
    countries = _all_stock_countries()
    off_count = sum(1 for k in countries if not _country_is_enabled(k))
    return render_body_text(
        "📦 <b>UPDATE STOCK / COUNTRY MANAGEMENT</b>\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        f"🌍 <b>Countries/Pairs:</b> {_stock_pair_count()}\n"
        f"📱 <b>Local Numbers:</b> {_country_local_count()}\n"
        f"🟠 <b>OFF Countries:</b> {off_count}\n"
        "━━━━━━━━━━━━━━━━━━━━\n"
        "✅ <b>Features:</b>\n"
        "1️⃣ Country ON/OFF\n"
        "2️⃣ Service + Country wise number upload\n"
        "3️⃣ Country-wise OTP price\n"
        "4️⃣ Country-wise NUM/REQ edit\n"
        "5️⃣ Stock view / reset / delete"
    )

def update_stock_keyboard():
    return {"inline_keyboard": [
        [{"text": "Upload Number", "icon_custom_emoji_id": "5353001161878182134", "callback_data": "upload_num", "style": "success"}],
        [{"text": "Country ON/OFF", "icon_custom_emoji_id": "5318840353510408444", "callback_data": "ustk_country_toggle", "style": "primary"},
         {"text": "Stock View", "icon_custom_emoji_id": "5352877703043258544", "callback_data": "ustk_stock_view", "style": "primary"}],
        [{"text": "OTP Price / NUM Request", "icon_custom_emoji_id": "5190576863226933563", "callback_data": "ustk_country_price", "style": "success"}],
        [{"text": "Reset Used", "icon_custom_emoji_id": "5352694861990501856", "callback_data": "ustk_reset_used", "style": "success"},
         {"text": "Delete Country Stock", "icon_custom_emoji_id": "5422557736330106570", "callback_data": "ustk_delete_country", "style": "danger"}],
        [{"text": "Back", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "back_to_admin", "style": "danger"}]
    ]}

def _country_toggle_keyboard():
    kb = []
    for key, name in _all_stock_countries().items():
        enabled = _country_is_enabled(key)
        kb.append([{"text": ("ON 🟢" if enabled else "OFF 🟠") + f" • {name}",
                   "icon_custom_emoji_id": _country_flag_emoji_id(key),
                   "callback_data": f"ustk_tog_{_country_cb_token(key)}",
                   "style": "success" if enabled else "danger"}])
    kb.append([{"text": "Back", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "update_stock", "style": "primary"}])
    return {"inline_keyboard": kb}

def _country_price_keyboard():
    kb = []
    for key, name in _all_stock_countries().items():
        setting = bot_settings.get("country_settings", {}).get(key, {})
        price = setting.get("price", bot_settings.get("otp_reward", 0))
        req = setting.get("num_req", bot_settings.get("num_req", 1))
        status = "🟢" if _country_is_enabled(key) else "🟠"
        kb.append([{"text": f"{name} {status} • ${price} • Req:{req}",
                    "icon_custom_emoji_id": _country_flag_emoji_id(key),
                    "callback_data": f"ustk_price_{_country_cb_token(key)}",
                    "style": "primary"}])
    kb.append([{"text": "Back", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "update_stock", "style": "danger"}])
    return {"inline_keyboard": kb}

def _country_detail_keyboard(key):
    token = _country_cb_token(key)
    return {"inline_keyboard": [
        [{"text": "Set OTP Price", "icon_custom_emoji_id": "5190576863226933563", "callback_data": f"ustk_setprice_{token}", "style": "success"},
         {"text": "Set NUM/REQ", "icon_custom_emoji_id": "5337132498965010628", "callback_data": f"ustk_setreq_{token}", "style": "primary"}],
        [{"text": "Clear Custom Settings", "icon_custom_emoji_id": "5422557736330106570", "callback_data": f"ustk_clear_{token}", "style": "danger"}],
        [{"text": "Back", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "ustk_country_price", "style": "primary"}]
    ]}

def _stock_view_text():
    grouped = {}
    for b in number_batches.values():
        nums = b.get("numbers", [])
        if not nums:
            continue
        service = str(b.get("service", "Unknown")).strip()
        country = str(b.get("country", "Unknown")).strip()
        grouped.setdefault(service, {}).setdefault(country, 0)
        grouped[service][country] += len(nums)
    if not grouped:
        return "📊 <b>STOCK VIEW</b>\n\n❌ No local stock found."
    lines = ["📊 <b>STOCK VIEW</b>", "━━━━━━━━━━━━━━━━━━━━"]
    for service in sorted(grouped):
        lines.append(f"\n📱 <b>{html.escape(service)}</b>")
        for country, count in sorted(grouped[service].items(), key=lambda x: x[0].lower()):
            status = "🟢" if _country_is_enabled(country) else "🟠"
            lines.append(f"  {status} {html.escape(_country_display(country))} : <b>{count}</b>")
    return "\n".join(lines)

def _delete_country_keyboard():
    kb = []
    for key, name in _all_stock_countries().items():
        kb.append([{"text": f"Delete • {name}",
                    "icon_custom_emoji_id": "5422557736330106570",
                    "callback_data": f"ustk_del_{_country_cb_token(key)}",
                    "style": "danger"}])
    kb.append([{"text": "Back", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "update_stock", "style": "primary"}])
    return {"inline_keyboard": kb}

def shark_control_keyboard():
    status = "🟢 𝐎𝐍" if bot_settings.get("shark_panel_on", False) else "🔴 𝐎𝐅𝐅"
    token_count = len(bot_settings.get("shark_tokens", []))
    return {"inline_keyboard": [
        [{"text": f"🦈 𝐒𝐡𝐚𝐫𝐤 𝐏𝐚𝐧𝐞𝐥: {status}", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "shark_toggle", "style": "success" if bot_settings.get("shark_panel_on") else "danger"}],
        [{"text": f"➕ 𝐀𝐝𝐝 𝐓𝐨𝐤𝐞𝐧 ({token_count})", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "shark_add_token", "style": "primary"}],
        [{"text": "🗑 𝐕𝐢𝐞𝐰 / 𝐃𝐞𝐥𝐞𝐭𝐞 𝐓𝐨𝐤𝐞𝐧𝐬", "icon_custom_emoji_id": "5422557736330106570", "callback_data": "shark_view_tokens", "style": "danger"}],
        [{"text": "🔍 𝐋𝐢𝐯𝐞 𝐀𝐏𝐈 𝐓𝐞𝐬𝐭", "icon_custom_emoji_id": "5310119944219927745", "callback_data": "shark_live_test", "style": "success"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "primary"}]
    ]}

def cr_control_keyboard():
    status = "🟢 𝐎𝐍" if bot_settings.get("cr_panel_on", False) else "🔴 𝐎𝐅𝐅"
    token_count = len(bot_settings.get("cr_tokens", []))
    return {"inline_keyboard": [
        [{"text": f"🌐 𝐂𝐑 𝐏𝐚𝐧𝐞𝐥: {status}", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "cr_toggle", "style": "success" if bot_settings.get("cr_panel_on") else "danger"}],
        [{"text": f"➕ 𝐀𝐝𝐝 𝐓𝐨𝐤𝐞𝐧 ({token_count})", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "cr_add_token", "style": "primary"}],
        [{"text": "🗑 𝐕𝐢𝐞𝐰 / 𝐃𝐞𝐥𝐞𝐭𝐞 𝐓𝐨𝐤𝐞𝐧𝐬", "icon_custom_emoji_id": "5422557736330106570", "callback_data": "cr_view_tokens", "style": "danger"}],
        [{"text": "🔍 𝐋𝐢𝐯𝐞 𝐀𝐏𝐈 𝐓𝐞𝐬𝐭", "icon_custom_emoji_id": "5310119944219927745", "callback_data": "cr_live_test", "style": "success"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "primary"}]
    ]}

def flex_control_keyboard():
    status = "🟢 𝐎𝐍" if bot_settings.get("flex_panel_on", False) else "🔴 𝐎𝐅𝐅"
    token_count = len(bot_settings.get("flex_tokens", []))
    current_url = bot_settings.get("flex_api_url", "") or "❌ 𝐍𝐨𝐭 𝐒𝐞𝐭"
    return {"inline_keyboard": [
        [{"text": f"⚡ 𝐅𝐥𝐞𝐱 𝐏𝐚𝐧𝐞𝐥: {status}", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "flex_toggle", "style": "success" if bot_settings.get("flex_panel_on") else "danger"}],
        [{"text": "🔗 𝐒𝐞𝐭 𝐀𝐏𝐈 𝐔𝐑𝐋", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "flex_set_url", "style": "primary"}],
        [{"text": f"➕ 𝐀𝐝𝐝 𝐓𝐨𝐤𝐞𝐧 ({token_count})", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "flex_add_token", "style": "primary"}],
        [{"text": "🗑 𝐕𝐢𝐞𝐰 / 𝐃𝐞𝐥𝐞𝐭𝐞 𝐓𝐨𝐤𝐞𝐧𝐬", "icon_custom_emoji_id": "5422557736330106570", "callback_data": "flex_view_tokens", "style": "danger"}],
        [{"text": "🔍 𝐋𝐢𝐯𝐞 𝐀𝐏𝐈 𝐓𝐞𝐬𝐭", "icon_custom_emoji_id": "5310119944219927745", "callback_data": "flex_live_test", "style": "success"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "primary"}]
    ]}

def nexus_control_keyboard():
    status = "🟢 𝐎𝐍" if bot_settings.get("nexus_panel_on", False) else "🔴 𝐎𝐅𝐅"
    key_count = len(bot_settings.get("nexus_keys", []))
    srv_count = len(bot_settings.get("nexus_services", {}))
    return {"inline_keyboard": [
        [{"text": f"🔷 𝐍𝐞𝐱𝐮𝐬-𝐗 𝐏𝐚𝐧𝐞𝐥: {status}", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "nexus_toggle", "style": "success" if bot_settings.get("nexus_panel_on") else "danger"}],
        [{"text": f"➕ 𝐀𝐝𝐝 𝐀𝐏𝐈 𝐊𝐞𝐲 ({key_count})", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "nexus_add_key", "style": "primary"}],
        [{"text": "🗑 𝐕𝐢𝐞𝐰 / 𝐃𝐞𝐥𝐞𝐭𝐞 𝐊𝐞𝐲𝐬", "icon_custom_emoji_id": "5422557736330106570", "callback_data": "nexus_view_keys", "style": "danger"}],
        [{"text": f"📦 𝐌𝐚𝐧𝐚𝐠𝐞 𝐒𝐞𝐫𝐯𝐢𝐜𝐞𝐬 ({srv_count})", "icon_custom_emoji_id": "5257969839313526622", "callback_data": "manage_nexus_srv", "style": "primary"}],
        [{"text": "🔍 𝐋𝐢𝐯𝐞 𝐀𝐏𝐈 𝐓𝐞𝐬𝐭", "icon_custom_emoji_id": "5310119944219927745", "callback_data": "nexus_live_test", "style": "success"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "primary"}]
    ]}

def system_settings_keyboard():
    return {"inline_keyboard": [
        [{"text": "𝐒𝐭𝐞𝐱 𝐂𝐨𝐧𝐭𝐫𝐨𝐥", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "stex_control", "style": "success"},
         {"text": "𝐕𝐨𝐥𝐭𝐱 𝐂𝐨𝐧𝐭𝐫𝐨𝐥", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "voltx_control", "style": "primary"}],
        [{"text": "𝐙𝐞𝐧𝐞𝐱 𝐂𝐨𝐧𝐭𝐫𝐨𝐥", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "zenex_control", "style": "success"},
         {"text": "🦈 𝐒𝐡𝐚𝐫𝐤 𝐏𝐚𝐧𝐞𝐥", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "shark_control", "style": "primary"}],
        [{"text": "🌐 𝐂𝐑 𝐏𝐚𝐧𝐞𝐥", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "cr_control", "style": "success"},
         {"text": "⚡ 𝐅𝐥𝐞𝐱 𝐏𝐚𝐧𝐞𝐥", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "flex_control", "style": "primary"}],
        [{"text": "🔷 𝐍𝐞𝐱𝐮𝐬-𝐗 𝐏𝐚𝐧𝐞𝐥", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "nexus_control", "style": "success"}],
        [{"text": "𝐅𝐨𝐫𝐜𝐞 𝐉𝐨𝐢𝐧 𝐒𝐲𝐬𝐭𝐞𝐦", "icon_custom_emoji_id": "5420517437885943844", "callback_data": "manage_fj", "style": "primary"},
         {"text": "𝐎𝐓𝐏 𝐆𝐫𝐨𝐮𝐩", "icon_custom_emoji_id": "6235727781427155894", "callback_data": "manage_otp_groups", "style": "danger"}],
        [{"text": "𝐀𝐝𝐦𝐢𝐧 𝐌𝐚𝐧𝐚𝐠𝐞𝐦𝐞𝐧𝐭", "icon_custom_emoji_id": "5420145051336485498", "callback_data": "manage_admins", "style": "danger"},
         {"text": "𝐔𝐬𝐞𝐫 𝐌𝐚𝐧𝐚𝐠𝐞𝐦𝐞𝐧𝐭", "icon_custom_emoji_id": "5193063022226086560", "callback_data": "user_management", "style": "primary"}],
        [{"text": "𝐏𝐚𝐧𝐞𝐥 𝐌𝐀𝐍𝐀𝐆𝐄𝐌𝐄𝐍𝐓", "icon_custom_emoji_id": "5336879280578138635", "callback_data": "manage_panels", "style": "danger"},
         {"text": "𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧", "icon_custom_emoji_id": "5190899075968441286", "callback_data": "dummy_alert", "style": "success"}],
        [{"text": "𝐏𝐫𝐞𝐦𝐢𝐮𝐦 𝐄𝐦𝐨𝐣𝐢", "icon_custom_emoji_id": "5352552689983067014", "callback_data": "manage_emojis", "style": "success"},
         {"text": "𝐑𝐎𝐌𝐀𝐍 𝐂𝐎𝐍𝐓𝐑𝐎𝐋", "icon_custom_emoji_id": "5193100774988617665", "callback_data": "dxa_control", "style": "primary"}],
        [{"text": "𝐌𝐞𝐧𝐮 𝐃𝐞𝐬𝐢𝐠𝐧", "icon_custom_emoji_id": "5190751148704833975", "callback_data": "menu_design_list", "style": "primary"},
         {"text": "𝐓𝐞𝐬𝐭", "icon_custom_emoji_id": "5190781475468915802", "callback_data": "test_message_flow", "style": "primary"}],
        [{"text": f"🔔 𝐏𝐚𝐧𝐞𝐥 𝐀𝐥𝐞𝐫𝐭: {'🟢 𝐎𝐍' if bot_settings.get('panel_alert_on', True) else '🔴 𝐎𝐅𝐅'}", "icon_custom_emoji_id": "5352980533150259581", "callback_data": "tog_panel_alert", "style": "success" if bot_settings.get("panel_alert_on", True) else "danger"},
         {"text": f"📩 𝐔𝐬𝐞𝐫 𝐎𝐓𝐏 𝐍𝐨𝐭𝐢𝐟𝐲: {'🟢 𝐎𝐍' if bot_settings.get('user_otp_notify', True) else '🔴 𝐎𝐅𝐅'}", "icon_custom_emoji_id": "5352694861990501856", "callback_data": "tog_user_otp_notify", "style": "success" if bot_settings.get("user_otp_notify", True) else "danger"}],
        [{"text": f"⚠️ 𝐍𝐨-𝐌𝐚𝐭𝐜𝐡 𝐀𝐥𝐞𝐫𝐭: {'🟢 𝐎𝐍' if bot_settings.get('no_match_alert_on', True) else '🔴 𝐎𝐅𝐅'}", "icon_custom_emoji_id": "5336944168944047463", "callback_data": "tog_no_match_alert", "style": "success" if bot_settings.get("no_match_alert_on", True) else "danger"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "back_to_admin", "style": "danger"}]
    ]}
...
✅ Verified Users : <i>Hidden</i>
🚫 Banned Users : <i>Hidden</i>
...
def user_management_keyboard():
    return {"inline_keyboard": [
        [{"text": "𝐌𝐚𝐧𝐚𝐠𝐞 𝐁𝐚𝐥𝐚𝐧𝐜𝐞", "icon_custom_emoji_id": "5190576863226933563", "callback_data": "um_manage_balance", "style": "primary"},
         {"text": "𝐁𝐚𝐧/𝐔𝐧𝐛𝐚𝐧 𝐔𝐬𝐞𝐫", "icon_custom_emoji_id": "5334807341109908955", "callback_data": "um_ban_unban", "style": "danger"}],
        [{"text": "𝐔𝐬𝐞𝐫 𝐏𝐫𝐨𝐟𝐢𝐥𝐞", "icon_custom_emoji_id": "5352861489541714456", "callback_data": "um_user_profile", "style": "success"},
         {"text": "💰 𝐔𝐬𝐞𝐫 𝐎𝐓𝐏 𝐑𝐚𝐭𝐞", "icon_custom_emoji_id": "5190576863226933563", "callback_data": "um_user_otp_rate", "style": "primary"}],
        [{"text": "📋 𝐕𝐢𝐞𝐰 𝐀𝐥𝐥 𝐔𝐬𝐞𝐫 𝐑𝐚𝐭𝐞𝐬", "icon_custom_emoji_id": "5352877703043258544", "callback_data": "um_view_user_rates", "style": "success"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "primary"}]
    ]}

def menu_design_list_keyboard():
    return {"inline_keyboard": [
        [{"text": "𝐄𝐝𝐢𝐭 /𝐬𝐭𝐚𝐫𝐭 𝐌𝐞𝐧𝐮", "icon_custom_emoji_id": "5395444784611480792", "callback_data": "md_edit_start", "style": "primary"}],
        [{"text": "𝐄𝐝𝐢𝐭 𝐆𝐞𝐭 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5337132498965010628", "callback_data": "md_edit_get_number", "style": "success"},
         {"text": "𝐄𝐝𝐢𝐭 𝐒𝐞𝐚𝐫𝐜𝐡 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5190645917711114179", "callback_data": "md_edit_search_number", "style": "success"}],
        [{"text": "𝐄𝐝𝐢𝐭 𝐒𝐞𝐥𝐞𝐜𝐭 𝐂𝐨𝐮𝐧𝐭𝐫𝐲", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "md_edit_select_country", "style": "primary"}],
        [{"text": "𝐄𝐝𝐢𝐭 𝐋𝐢𝐯𝐞 𝐓𝐫𝐚𝐟𝐟𝐢𝐜", "icon_custom_emoji_id": "5353032893096567467", "callback_data": "md_edit_traffic", "style": "primary"},
         {"text": "𝐄𝐝𝐢𝐭 𝐑𝐞𝐟𝐞𝐫", "icon_custom_emoji_id": "5420396762189831222", "callback_data": "md_edit_refer", "style": "primary"}],
        [{"text": "𝐄𝐝𝐢𝐭 𝐖𝐢𝐭𝐡𝐝𝐫𝐚𝐰𝐚𝐥", "icon_custom_emoji_id": "5352585194295564660", "callback_data": "md_edit_withdrawal", "style": "danger"},
         {"text": "𝐄𝐝𝐢𝐭 𝐒𝐮𝐩𝐩𝐨𝐫𝐭", "icon_custom_emoji_id": "5420145051336485498", "callback_data": "md_edit_support", "style": "danger"}],
        [{"text": "𝐑𝐞𝐬𝐞𝐭 𝐃𝐞𝐟𝐚𝐮𝐥𝐭𝐬", "icon_custom_emoji_id": "5192812028632274956", "callback_data": "md_reset_defaults", "style": "success"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "primary"}]
    ]}

def menu_edit_options_keyboard(menu_key):
    return {"inline_keyboard": [
        [{"text": "𝐄𝐝𝐢𝐭 𝐁𝐨𝐝𝐲 (𝐓𝐞𝐱𝐭)", "icon_custom_emoji_id": "5395444784611480792", "callback_data": f"md_text_{menu_key}", "style": "primary"}],
        [{"text": "𝐄𝐝𝐢𝐭 𝐈𝐧𝐥𝐢𝐧𝐞 𝐁𝐮𝐭𝐭𝐨𝐧𝐬", "icon_custom_emoji_id": "5420155432272438703", "callback_data": f"md_btns_{menu_key}", "style": "success"}],
        [{"text": "𝐁𝐚𝐜𝐤 𝐭𝐨 𝐌𝐞𝐧𝐮𝐬", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "menu_design_list", "style": "danger"}]
    ]}
...
def menu_buttons_list_keyboard(menu_key):
    ...
    for idx, btn in enumerate(btns):
        kb.append([{"text": f"𝐃𝐞𝐥: {btn['text']}", "icon_custom_emoji_id": "5420130255174145507", "callback_data": f"md_delbtn_{menu_key}_{idx}", "style": "danger"}])
    kb.append([{"text": "𝐀𝐝𝐝 𝐈𝐧𝐥𝐢𝐧𝐞 𝐁𝐮𝐭𝐭𝐨𝐧", "icon_custom_emoji_id": "5420323438508155202", "callback_data": f"md_addbtn_{menu_key}", "style": "success"}])
    kb.append([{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": f"md_edit_{menu_key}", "style": "primary"}])
    return {"inline_keyboard": kb}
...
def emoji_settings_keyboard():
    return {"inline_keyboard": [
        [{"text": "𝐔𝐩𝐥𝐨𝐚𝐝 𝐅𝐥𝐚𝐠𝐬 (𝐓𝐗𝐓)", "icon_custom_emoji_id": "5353001161878182134", "callback_data": "up_flags_txt", "style": "primary"},
         {"text": "𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐅𝐥𝐚𝐠𝐬", "icon_custom_emoji_id": "5257969839313526622", "callback_data": "dl_flags_txt", "style": "success"}],
        [{"text": "𝐔𝐩𝐥𝐨𝐚𝐝 𝐒𝐞𝐫𝐯𝐢𝐜𝐞𝐬 (𝐓𝐗𝐓)", "icon_custom_emoji_id": "5353001161878182134", "callback_data": "up_apps_txt", "style": "primary"},
         {"text": "𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐒𝐞𝐫𝐯𝐢𝐜𝐞𝐬", "icon_custom_emoji_id": "5257969839313526622", "callback_data": "dl_apps_txt", "style": "success"}],
        [{"text": "𝐃𝐞𝐥𝐞𝐭𝐞 𝐀𝐥𝐥 𝐅𝐥𝐚𝐠𝐬", "icon_custom_emoji_id": "5422557736330106570", "callback_data": "del_all_flags", "style": "danger"},
         {"text": "𝐀𝐝𝐝 𝐒𝐢𝐧𝐠𝐥𝐞 𝐄𝐦𝐨𝐣𝐢", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "add_single_emoji", "style": "success"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "danger"}]
    ]}

def fj_settings_keyboard():
    status_text = '𝐎𝐍' if bot_settings['fj_on'] else '𝐎𝐅𝐅'
    status_icon = "5352694861990501856" if bot_settings['fj_on'] else "5318840353510408444"
    kb = [[{"text": f"𝐒𝐓𝐀𝐓𝐔𝐒: {status_text}", "icon_custom_emoji_id": status_icon, "callback_data": "toggle_fj", "style": "primary"}]]
    for idx, ch in enumerate(bot_settings["fj_channels"]):
        kb.append([{"text": f"𝐃𝐞𝐥𝐞𝐭𝐞: {ch}", "icon_custom_emoji_id": "5420130255174145507", "callback_data": f"del_fj_{idx}", "style": "danger"}])
    kb.append([{"text": "𝐀𝐝𝐝 𝐂𝐡𝐚𝐧𝐧𝐞𝐥", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "add_fj", "style": "success"}])
    kb.append([{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "primary"}])
    return {"inline_keyboard": kb}

def admin_settings_keyboard():
    kb = []
    for idx, adm in enumerate(bot_settings["admins"]):
        text_btn = f"𝐎𝐰𝐧𝐞𝐫: {adm}" if adm == OWNER_ID else f"𝐃𝐞𝐥𝐞𝐭𝐞: {adm}"
    ...
    kb.append([{"text": "𝐀𝐝𝐝 𝐀𝐝𝐦𝐢𝐧", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "add_adm", "style": "success"}])
    kb.append([{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "primary"}])
    return {"inline_keyboard": kb}

def otp_groups_list_keyboard():
    kb = [[{"text": "𝐄𝐝𝐢𝐭 𝐎𝐓𝐏 𝐁𝐮𝐭𝐭𝐨𝐧 𝐋𝐢𝐧𝐤", "icon_custom_emoji_id": "5420517437885943844", "callback_data": "edit_otp_link", "style": "primary"}],
          [{"text": "𝐄𝐝𝐢𝐭 𝐌𝐚𝐢𝐧 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐋𝐢𝐧𝐤", "icon_custom_emoji_id": "5217822164362739968", "callback_data": "edit_main_channel", "style": "primary"}]]
    for idx, fg in enumerate(bot_settings["fw_groups"]):
        kb.append([{"text": f"𝐆𝐫𝐨𝐮𝐩: {fg['chat_id']}", "icon_custom_emoji_id": "5193063022226086560", "callback_data": f"manage_fw_{idx}", "style": "primary"}])
    kb.append([{"text": "𝐀𝐝𝐝 𝐅𝐨𝐫𝐰𝐚𝐫𝐝 𝐆𝐫𝐨𝐮𝐩", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "add_fw", "style": "success"}])
    kb.append([{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "danger"}])
    return {"inline_keyboard": kb}


def stex_control_keyboard():
    return {"inline_keyboard": [
        [{"text": "𝐀𝐝𝐝 𝐒𝐭𝐞𝐱 𝐊𝐞𝐲", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "add_stex_key", "style": "success"},
         {"text": "𝐕𝐢𝐞𝐰/𝐃𝐞𝐥 𝐊𝐞𝐲𝐬", "icon_custom_emoji_id": "5422557736330106570", "callback_data": "view_stex_keys", "style": "danger"}],
        [{"text": "𝐌𝐚𝐧𝐚𝐠𝐞 𝐒𝐭𝐞𝐱 𝐒𝐞𝐫𝐯𝐢𝐜𝐞𝐬", "icon_custom_emoji_id": "5192739271886282680", "callback_data": "manage_stex_srv", "style": "success"}],
        [{"text": "𝐒𝐞𝐚𝐫𝐜𝐡 𝐂𝐨𝐮𝐧𝐭𝐫𝐲", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "stex_search_country", "style": "primary"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "primary"}]
    ]}

def voltx_control_keyboard():
    return {"inline_keyboard": [
        [{"text": "𝐀𝐝𝐝 𝐕𝐨𝐥𝐭𝐱 𝐊𝐞𝐲", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "add_voltx_key", "style": "success"},
         {"text": "𝐕𝐢𝐞𝐰/𝐃𝐞𝐥 𝐊𝐞𝐲𝐬", "icon_custom_emoji_id": "5422557736330106570", "callback_data": "view_voltx_keys", "style": "danger"}],
        [{"text": "𝐌𝐚𝐧𝐚𝐠𝐞 𝐕𝐨𝐥𝐭𝐱 𝐒𝐞𝐫𝐯𝐢𝐜𝐞𝐬", "icon_custom_emoji_id": "5192739271886282680", "callback_data": "manage_voltx_srv", "style": "success"}],
        [{"text": "𝐒𝐞𝐚𝐫𝐜𝐡 𝐂𝐨𝐮𝐧𝐭𝐫𝐲", "icon_custom_emoji_id": "5336972142066047577", "callback_data": "voltx_search_country", "style": "primary"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "primary"}]
    ]}

def zenex_control_keyboard():
    return {"inline_keyboard": [
        [{"text": "𝐀𝐝𝐝 𝐙𝐞𝐧𝐞𝐱 𝐊𝐞𝐲", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "add_zenex_key", "style": "success"},
         {"text": "𝐕𝐢𝐞𝐰/𝐃𝐞𝐥 𝐊𝐞𝐲𝐬", "icon_custom_emoji_id": "5422557736330106570", "callback_data": "view_zenex_keys", "style": "danger"}],
        [{"text": "𝐌𝐚𝐧𝐚𝐠𝐞 𝐙𝐞𝐧𝐞𝐱 𝐒𝐞𝐫𝐯𝐢𝐜𝐞𝐬", "icon_custom_emoji_id": "5192739271886282680", "callback_data": "manage_zenex_srv", "style": "success"}],
        [{"text": "𝐁𝐚𝐜𝐤", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "primary"}]
    ]}
...
def specific_fw_group_keyboard(idx):
    ...
    kb.append([{"text": "𝐀𝐝𝐝 𝐈𝐧𝐥𝐢𝐧𝐞 𝐁𝐮𝐭𝐭𝐨𝐧", "icon_custom_emoji_id": "5420323438508155202", "callback_data": f"add_fwbtn_{idx}", "style": "success"}])
    kb.append([{"text": "𝐃𝐞𝐥𝐞𝐭𝐞 𝐄𝐧𝐭𝐢𝐫𝐞 𝐆𝐫𝐨𝐮𝐩", "icon_custom_emoji_id": "5422557736330106570", "callback_data": f"del_fw_{idx}", "style": "danger"}])
    kb.append([{"text": "𝐁𝐚𝐜𝐤 𝐭𝐨 𝐆𝐫𝐨𝐮𝐩𝐬", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "manage_otp_groups", "style": "primary"}])
    return {"inline_keyboard": kb}

def channel_podcast_keyboard():
    """Manage up to 4 Telegram channels for automatic New Number announcements."""
    targets = bot_settings.get("channel_podcast_targets", [])
    kb = []

    if not isinstance(targets, list):
        targets = []
        bot_settings["channel_podcast_targets"] = targets
    ...
    for idx, target in enumerate(targets[:4]):
        ...
        label = title[:28] if title else chat_id
        kb.append([{
            "text": f"🗑 𝐃𝐞𝐥𝐞𝐭𝐞: {label}",
            "icon_custom_emoji_id": "5422557736330106570",
            "callback_data": f"dxa_del_channel_podcast_{idx}",
            "style": "danger"
        }])

    if len(targets) < 4:
        kb.append([{
            "text": f"➕ 𝐀𝐝𝐝 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 ({len(targets)}/4)",
            "icon_custom_emoji_id": "5420323438508155202",
            "callback_data": "dxa_add_channel_podcast",
            "style": "success"
        }])
    else:
        kb.append([{
            "text": "🔒 𝐌𝐚𝐱𝐢𝐦𝐮𝐦 𝟒 𝐂𝐡𝐚𝐧𝐧𝐞𝐥𝐬",
            "icon_custom_emoji_id": "5420155432272438703",
            "callback_data": "ignore",
            "style": "primary"
        }])

    kb.append([{
        "text": "𝐁𝐚𝐜𝐤 𝐭𝐨 𝐑𝐎𝐌𝐀𝐍 𝐂𝐎𝐍𝐓𝐑𝐎𝐋",
        "icon_custom_emoji_id": "5267490665117275176",
...
def dxa_control_keyboard():
    w_status = "𝐎𝐍" if bot_settings["withdraw_on"] else "𝐎𝐅𝐅"
    sup_status = "𝐎𝐍" if bot_settings.get("support_link") else "𝐎𝐅𝐅"
    grp_status = "𝐎𝐍" if bot_settings.get("w_group") else "𝐎𝐅𝐅"
    pub_status = "𝐎𝐍" if bot_settings.get("w_public_channel") else "𝐎𝐅𝐅"
    bulk_auto = "𝐎𝐍 ✅" if bot_settings.get("bulk_auto_approve") else "𝐎𝐅𝐅 ❌"
    return {"inline_keyboard": [
        [{"text": f"𝐖𝐢𝐭𝐡𝐝𝐫𝐚𝐰 : {w_status}", "icon_custom_emoji_id": "5348469219761626211", "callback_data": "dxa_toggle_w", "style": "primary"}],
        [{"text": f"𝐌𝐢𝐧𝐢𝐦𝐮𝐦 𝐖𝐢𝐭𝐡𝐝𝐫𝐚𝐰 : {bot_settings['min_withdraw']}", "icon_custom_emoji_id": "5352877703043258544", "callback_data": "dxa_min_w", "style": "success"},
         {"text": f"𝐎𝐓𝐏 𝐑𝐄𝐖𝐀𝐑𝐃 : {bot_settings['otp_reward']}", "icon_custom_emoji_id": "5190576863226933563", "callback_data": "dxa_otp_r", "style": "primary"}],
        [{"text": f"𝐑𝐄𝐅𝐄𝐑 𝐑𝐄𝐖𝐀𝐑𝐃 : {bot_settings['refer_reward']}", "icon_custom_emoji_id": "5420396762189831222", "callback_data": "dxa_ref_r", "style": "success"},
         {"text": f"𝐂𝐎𝐎𝐋𝐃𝐎𝐖𝐍 : {bot_settings['cooldown']}s", "icon_custom_emoji_id": "5337172996211648018", "callback_data": "dxa_cool", "style": "primary"}],
        [{"text": f"𝐍𝐔𝐌/𝐑𝐄𝐐 : {bot_settings['num_req']}", "icon_custom_emoji_id": "5337132498965010628", "callback_data": "dxa_num_req", "style": "success"},
         {"text": f"𝐍𝐔𝐌/𝐒𝐇𝐀𝐑𝐄 : {bot_settings['num_share']}", "icon_custom_emoji_id": "5352862640592949843", "callback_data": "dxa_num_share", "style": "primary"}],
        [{"text": f"𝐒𝐮𝐩𝐩𝐨𝐫𝐭 𝐋𝐈𝐍𝐊 : {sup_status}", "icon_custom_emoji_id": "5420145051336485498", "callback_data": "dxa_sup_link", "style": "success"},
         {"text": "𝐖. 𝐌𝐄𝐓𝐇𝐎𝐃𝐒 ", "icon_custom_emoji_id": "5190899075968441286", "callback_data": "manage_w_methods", "style": "primary"}],
        [{"text": "𝐒𝐄𝐑𝐕𝐈𝐂𝐄 𝐑𝐀𝐓𝐄𝐒 ", "icon_custom_emoji_id": "5190576863226933563", "callback_data": "dxa_service_rates", "style": "success"},
         {"text": f"𝐖. 𝐆𝐑𝐎𝐔𝐏 : {grp_status}", "icon_custom_emoji_id": "5420517432272438703", "callback_data": "dxa_w_group", "style": "primary"}],
        [{"text": f"📣 𝐖. 𝐏𝐔𝐁𝐋𝐈𝐂 : {pub_status}", "icon_custom_emoji_id": "5780471598922337683", "callback_data": "dxa_w_public", "style": "primary"}],
        [{"text": f"📦 𝐁𝐔𝐋𝐊 𝐀𝐔𝐓𝐎 𝐀𝐏𝐏𝐑𝐎𝐕𝐄: {bulk_auto}", "icon_custom_emoji_id": "5352694861990501856", "callback_data": "dxa_toggle_bulk_auto", "style": "success" if bot_settings.get("bulk_auto_approve") else "danger"}],
        [{"text": f"𝐑𝐀𝐍𝐃 𝐍𝐀𝐌𝐄 𝐏𝐀𝐒𝐒: {'𝐒𝐄𝐓 ✅' if bot_settings.get('rand_name_pass') else '𝐍𝐎𝐓 𝐒𝐄𝐓 ❌'}", "icon_custom_emoji_id": "5352552689983067014", "callback_data": "dxa_set_rand_pass", "style": "primary"}],
        [{"text": f"📡 𝐎𝐓𝐏 𝐆𝐑𝐎𝐔𝐏 : {bot_settings.get('private_log_group_id') or 'NOT SET'}", "callback_data": "dxa_otp_group", "style": "success"}],
        [{"text": f"📣 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐏𝐎𝐃𝐂𝐀𝐒𝐓 : {len(bot_settings.get('channel_podcast_targets', []))}/4", "callback_data": "dxa_channel_podcast", "style": "primary"}],
        [{"text": "𝐁𝐀𝐂𝐊", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "system_settings", "style": "danger"}]
    ]}
...
def build_traffic_ui():
    ...
    recent_traffic = [
        ...
        if current_time - t.get("time", 0) <= 1800
    ]
    ...
    for t in recent_traffic:
        ...
        country_totals[iso] = (
            country_totals.get(iso, 0) + 1
        )

    # =========================================================
    # TOTAL RESULTS
    # =========================================================
    results_sent = len(recent_traffic)
    ...
    # =========================================================
    def get_country_name(iso):
        for code, fdata in bot_settings.get(
            "premium_flags",
            {}
        ).items():
    ...
    # TOP COUNTRY
    # =========================================================
    if sorted_countries and results_sent > 0:

        top_iso, top_count = sorted_countries[0]

        top_country_name = get_country_name(
            top_iso
        )

        top_percentage = (
            top_count / results_sent
        ) * 100

        top_flag_html = get_flag_info_html(
            top_iso
        )

        top_country = (
            f"{top_flag_html} "
            f"<b>{top_country_name}</b> "
            f"<b>{top_percentage:.1f}%</b>"
        )
    ...
    for index, (iso, count) in enumerate(
        sorted_countries[:3],
        start=1
    ):
        ...
        prem_flag_html = get_flag_info_html(
            iso
        )
        ...
        top_countries_lines.append(
            f"{index}. "
            f"{prem_flag_html} "
            f"<b>{country_name}</b> "
            f"➡️ <b>{percentage:.1f}%</b>"
        )

    # =========================================================
    # IF NO TRAFFIC
    # =========================================================
    if top_countries_lines:
        top_countries = "\n".join(
            top_countries_lines
        )
    else:
        top_countries = (
            "<i>No traffic in the last 30 minutes</i>"
        )

    # =========================================================
    # MAIN LIVE TRAFFIC UI
    # =========================================================
    txt = (
        "╭━━━━━━━━━━━━━━━━━━━━━━╮\n"
        "┃  🔴 <b>Live Traffic</b>\n"
        ...
        "🥇 <b>Window:</b> Last 30 minutes\n"
        f"⏱️ <b>Results Sent:</b> "
        f"{results_sent}\n"
...
def _handle_message_inner(msg):
    ...
    text = normalize_localized_command(chat_id, msg.get("text", ""))
    ...
    if text.startswith("/start"):
        ...
        if len(parts) > 1 and parts[1].isdigit():
            inviter = int(parts[1])
            if inviter != chat_id:
                # Save referred_by (works with or without Firestore)
                u_data = get_user(chat_id)
                if not u_data.get("referred_by"):
                    if not db:
                        _get_local_user(chat_id)["referred_by"] = inviter
                        _get_local_user(chat_id)["ref_paid"] = False
                        _save_users_local()
                    else:
                        try:
                    ...
                    if cached:
                        cached["referred_by"] = inviter
                        cached["ref_paid"] = False
                        _cache_set(chat_id, cached)
                        
    if not check_force_join(chat_id):
        send_force_join_msg(chat_id)
        return

    # First successful Force-Join verification opens the language selector.
    if text.startswith("/start") and not has_selected_language(chat_id):
        send_language_selector(chat_id)
        return
    ...
    if is_admin(chat_id) and msg.get("reply_to_message") and text:
        ...
        if target_user:
            send_message(target_user, render_body_text(
                f"💬 <b>Official Support Response</b>\n\n{text}"
            ))
            send_message(chat_id, render_body_text("✅ Reply sent to user."))
            return
    # ─────────────────────────────────────────────────────────────────────────

    MAIN_MENU_CMDS = ["Get Number", "Search Number", "Leaderboard", "Live Traffic", "Withdrawal", "Support", "Admin Panel"]
    ...
    if chat_id in user_states and not is_main_cmd:
        ...
        # --- User Management Flows ---
            ...
            if db:
                try:
                    db.collection('users').document(str(target_uid)).update({"banned": new_status})
                except Exception as e:
                    print(f"⚠️ ban update Firestore failed: {e}")
            else:
                _get_local_user(target_uid)["banned"] = new_status
                _save_users_local()
            # cache ও update করো
            cached = _cache_get(target_uid)
            if cached:
                cached["banned"] = new_status
                _cache_set(target_uid, cached)
...
┃  💰 Balance       : <b>{data.get('balance', 0.0)} USDT</b>
┃  🤝 Total Refers  : <b>{data.get('total_refers', 0)}</b>
┃  🔐 Total OTPs    : <b>{data.get('total_otps', 0)}</b>
┃  ✅ Verified      : <b>{is_verified}</b>
┃  🚫 Banned        : <b>{data.get('banned', False)}</b>
╰━━━━━━━━━━━━━━━━━━━━━━╯"""
        ...
        # --- Menu Design Flow ---
            ...
            _user_send_otp(chat_id, char, iso, prem_app_html, display_num_test, otp, 0, False, lang=locals().get("lang"))
            del user_states[chat_id]
            del temp_data[chat_id]
            return
            ...
            detected_iso = None
            detected_flag_html = None
            if clean_nums:
                try:
                    _char, detected_iso = get_flag_and_code(clean_nums[0])
                    if detected_iso and detected_iso != "XX":
                        detected_flag_html = get_flag_info_html(detected_iso)
                except Exception:
                    detected_iso = None

            # If phone-prefix detection is unavailable, resolve the admin-entered
            # country against the Premium Flag database.
            country_upper = str(country).strip().upper()
            if not detected_iso or detected_iso == "XX":
                for _code, _fd in bot_settings.get("premium_flags", {}).items():
                    _iso = str(_fd.get("iso", "")).upper()
                    _name = str(_fd.get("name", "")).upper()
                    if country_upper in {_iso, _name} or (country_upper and _name and (country_upper in _name or _name in country_upper)):
                        detected_iso = _iso or None
                        try:
                            detected_flag_html = get_flag_info_html(detected_iso) if detected_iso else None
                        except Exception:
                            detected_flag_html = None
                        break

            # The admin-selected country is authoritative for stock/settings.
            # Never replace it with a phone-prefix detected country here; doing
            # so can make one uploaded country's UI show another country's name.
            country = _country_key(country)
            country_name = _country_display(country)
            detected_flag_html = None
            try:
                detected_flag_html = get_flag_info_html(country)
            except Exception:
                detected_flag_html = None
            country_line = f"{detected_flag_html} {country_name}" if detected_flag_html else f"{PEM['world']} {country_name}"
            number_batches[batch_id]["country"] = country

            # /start deep-link: Telegram opens the bot and runs the normal start flow.
            bot_username_clean = str(BOT_USERNAME).lstrip("@").strip()
            get_number_url = f"https://t.me/{bot_username_clean}?start=allocate" if bot_username_clean else "https://t.me/"

            broadcast_txt = render_body_text(
                f"🚨 <b>New Number Added!</b>\n\n"
                f"<b>Service :</b> {prem_app_html} {html.escape(app_full_name)}\n"
                f"<b>Country :</b> {country_name}\n"
                f"<b>Capacity :</b> {len(clean_nums)}\n\n"
                f"📋 <b>All Numbers</b> /start Allocate 💝❤️"
            )
            broadcast_kb = {
                "inline_keyboard": [[
                    {
            ...
            send_message(chat_id, render_body_text(f"{PEM['ok']} Numbers added to local stock! Starting OTV broadcast..."))

            def simple_broadcast(txt, reply_markup):
                b_session = requests.Session()
                url = f"{BASE_URL}/sendMessage"
                success = 0
                failed = 0

                # Private-user broadcast.
                for u_id in list(all_known_users):
                    try:
                        ...
                        response = b_session.post(url, json=payload, timeout=8)
                ...
                # Existing OTV/OTP forward groups. A failed group never stops the others.
                for fw in list(bot_settings.get("fw_groups", [])):
                    try:
                        if isinstance(fw, dict) and fw.get("chat_id"):
                            send_message(fw["chat_id"], txt, reply_markup=reply_markup)
                    except Exception as e:
                        print(f"⚠️ OTV number announcement group failed: {e}")

                # Channel Podcast targets: send the same New Number announcement
                # independently to every configured channel. One failure never
                # prevents the remaining channels from receiving it.
                podcast_targets = list(bot_settings.get("channel_podcast_targets", []))
                podcast_ok = 0
                podcast_failed = 0
                for target in podcast_targets[:4]:
                    try:
                        target_id = target.get("chat_id") if isinstance(target, dict) else target
                        if not target_id:
                            continue
                        payload = {
                            "chat_id": target_id,
                        ...
                        if response.ok and result.get("ok"):
                            ...
                            podcast_failed += 1
                            print(
                                f"⚠️ Channel Podcast failed for {target_id}: "
                                f"{result.get('description', response.text[:160])}"
                            )
                    except Exception as e:
                        podcast_failed += 1
                        print(f"⚠️ Channel Podcast exception for {target}: {e}")

                print(
                    f"📣 OTV New Number broadcast finished: "
                    f"users_success={success}, users_failed={failed}, "
                    f"podcast_success={podcast_ok}, podcast_failed={podcast_failed}, "
                    f"capacity={len(clean_nums)}"
                )

            threading.Thread(
                target=simple_broadcast,
                args=(broadcast_txt, broadcast_kb),
                daemon=True
            ).start()
        ...
        elif state == "wait_for_add_nexus_key" and text:
            new_key = text.strip()
            if "nexus_keys" not in bot_settings:
                bot_settings["nexus_keys"] = []
            bot_settings["nexus_keys"].append(new_key)
            save_db()
            delete_message(chat_id, msg["message_id"])
            edit_message(chat_id, temp_data[chat_id]["msg_id"],
                render_body_text(f"✅ Nexus-X API Key Added!\nTotal Keys: {len(bot_settings['nexus_keys'])}"),
                reply_markup=nexus_control_keyboard())
            del user_states[chat_id]
            del temp_data[chat_id]
            return
            ...
            edit_message(chat_id, temp_data[chat_id]["msg_id"],
                render_body_text(
                    ...
                    f"📝 কত USDT দিতে চান প্রতি OTP তে?\n"
            ...
            if rate_val <= 0:
                ...
                result_txt = f"✅ User <code>{uid_key}</code> এর OTP Rate: <b>{rate_val} USDT</b> সেট হয়েছে!"
            save_db()
            delete_message(chat_id, msg["message_id"])
            edit_message(chat_id, temp_data[chat_id]["msg_id"],
        ...
        # ── Nexus Services State Handlers ──────────────────────────────────
        elif state == "wait_nxs_srv_name" and text:
            srv = text.strip().upper()
            if "nexus_services" not in bot_settings: bot_settings["nexus_services"] = {}
            if srv not in bot_settings["nexus_services"]: bot_settings["nexus_services"][srv] = {}
            save_db()
            delete_message(chat_id, msg["message_id"])
            handle_callback({"message": {"chat": {"id": chat_id}, "message_id": temp_data[chat_id]["msg_id"]}, "data": "manage_nexus_srv", "id": "internal"})
            del user_states[chat_id]
            return

        elif state == "wait_nxs_cnt_name" and text:
            cnt = text.strip()
            srv = temp_data[chat_id]["srv"]
            if "nexus_services" not in bot_settings: bot_settings["nexus_services"] = {}
            if srv not in bot_settings["nexus_services"]: bot_settings["nexus_services"][srv] = {}
            if cnt not in bot_settings["nexus_services"][srv]: bot_settings["nexus_services"][srv][cnt] = []
            save_db()
            delete_message(chat_id, msg["message_id"])
            handle_callback({"message": {"chat": {"id": chat_id}, "message_id": temp_data[chat_id]["msg_id"]}, "data": f"nxs_srv_{srv}", "id": "internal"})
            del user_states[chat_id]
            return

        elif state == "wait_nxs_addr" and text:
            srv, cnt = temp_data[chat_id]["srv"], temp_data[chat_id]["cnt"]
            new_range = text.strip().replace("+", "")
            ...
            if new_range not in bot_settings["nexus_services"][srv][cnt]:
                bot_settings["nexus_services"][srv][cnt].append(new_range)
                save_db()

            delete_message(chat_id, msg["message_id"])
            handle_callback({"message": {"chat": {"id": chat_id}, "message_id": temp_data[chat_id]["msg_id"]}, "data": f"nxs_cnt_{srv}_{cnt}", "id": "internal"})
            del user_states[chat_id]
            return
        ...
        elif state == "wait_for_channel_podcast_id" and text:
            msg_id = temp_data.get(chat_id, {}).get("msg_id")
            raw = text.strip()

            try:
                targets = bot_settings.setdefault("channel_podcast_targets", [])
                if len(targets) >= 4:
                    raise ValueError("Maximum 4 channels allowed")

                target_id = parse_chat_id(raw)

                # Validate the destination before saving it. This prevents most
                # malformed IDs/usernames from being stored and later failing.
                chat_res = api_call("getChat", {"chat_id": target_id})
                ...
                if chat_type != "channel":
                    raise ValueError("Destination is not a Telegram channel")

                # Duplicate protection (supports legacy string entries too).
                existing_ids = set()
                for item in targets:
                    existing_ids.add(
                        str(item.get("chat_id", "")) if isinstance(item, dict) else str(item)
                    )
                if str(target_id) in existing_ids:
                    raise ValueError("Channel already added")
                ...
                edit_message(
                    ...
                    render_body_text(
                        ...
                        f"📢 <b>{html.escape(title or 'Telegram Channel')}</b>\n"
                        f"🆔 <code>{html.escape(str(target_id))}</code>\n\n"
                        "Number announcements will now be sent automatically."
                    ),
                    reply_markup=channel_podcast_keyboard()
                )
            except Exception as e:
                edit_message(
                    chat_id,
                    msg_id,
                    render_body_text(
                        "❌ <b>Channel Add Failed</b>\n\n"
                        f"{html.escape(str(e))}\n\n"
                        "Send a valid Channel ID such as "
                        "<code>-1001234567890</code> or a public "
                        "<code>@username</code>.\n"
                        "Also make sure the bot is an Administrator."
                    ),
                    reply_markup={
                        "inline_keyboard": [[
                            {
                                "text": "Cancel",
                                "icon_custom_emoji_id": "5267490665117275176",
                                "callback_data": "dxa_channel_podcast",
                                "style": "danger"
                            }
                        ]]
                    }
        ...
        elif state == "wait_for_otp_group" and text:
            msg_id = temp_data[chat_id].get("msg_id")
            raw = text.strip()
            try:
                group_id = int(raw)
                if group_id >= 0:
                    raise ValueError("Group ID must normally be negative")
                bot_settings["private_log_group_id"] = group_id
                save_db()
                delete_message(chat_id, msg["message_id"])
                edit_message(chat_id, msg_id, render_body_text(
                    "🕹 <b>ROMAN CONTROL PANEL</b>\n\n"
                    f"✅ OTP Group ID updated: <code>{group_id}</code>\n\n"
                    "New OTP event notifications will use this group."
                ), reply_markup=dxa_control_keyboard())
            except Exception:
        ...
        elif state == "wait_for_rand_pass" and text:
            msg_id = temp_data[chat_id].get("msg_id")
            bot_settings["rand_name_pass"] = text.strip()
            save_db()
            delete_message(chat_id, msg["message_id"])
            if msg_id:
                edit_message(chat_id, msg_id, render_body_text(
                    f"🕹 <b>ROMAN CONTROL PANEL</b>\n\n✅ Random Name Pass set করা হয়েছে:\n<code>{text.strip()}</code>"
                ), reply_markup=dxa_control_keyboard())
            del user_states[chat_id]
            del temp_data[chat_id]
            return
        ...
        elif state == "ustk_set_price":
            msg_id = temp_data[chat_id]["msg_id"]
            key = _country_key(temp_data[chat_id]["country"])
            try:
                price = float(text.strip())
                if price < 0: raise ValueError
                bot_settings.setdefault("country_settings", {}).setdefault(key, {})["price"] = price
                save_db()
                delete_message(chat_id, msg["message_id"])
                edit_message(chat_id, msg_id, render_body_text(
                    f"💰 <b>Set OTP Price</b>\n\n🌍 <b>Country:</b> {_country_display(key)}\n"
                    f"✅ OTP Price set to: ${price}"
                ), reply_markup=_country_detail_keyboard(key))
            except Exception:
                delete_message(chat_id, msg["message_id"])
                edit_message(chat_id, msg_id, render_body_text(
                    f"💰 <b>Set OTP Price</b>\n\n🌍 <b>Country:</b> {_country_display(key)}\n"
                    "❌ Invalid price. Send a number like <code>0.10</code> or <code>1</code>."
                ), reply_markup={"inline_keyboard": [[{"text": "Cancel", "callback_data": f"ustk_price_{_country_cb_token(key)}", "style": "danger"}]]})
            del user_states[chat_id]
            del temp_data[chat_id]
            return

        elif state == "ustk_set_req":
            msg_id = temp_data[chat_id]["msg_id"]
            key = _country_key(temp_data[chat_id]["country"])
            try:
                req = int(text.strip())
                if req < 1: raise ValueError
                bot_settings.setdefault("country_settings", {}).setdefault(key, {})["num_req"] = req
                save_db()
                delete_message(chat_id, msg["message_id"])
                edit_message(chat_id, msg_id, render_body_text(
                    f"📱 <b>Set NUM/REQ</b>\n\n🌍 <b>Country:</b> {_country_display(key)}\n"
                    f"✅ NUM/REQ set to: {req}"
                ), reply_markup=_country_detail_keyboard(key))
            except Exception:
                delete_message(chat_id, msg["message_id"])
                edit_message(chat_id, msg_id, render_body_text(
                    f"📱 <b>Set NUM/REQ</b>\n\n🌍 <b>Country:</b> {_country_display(key)}\n"
                    "❌ Invalid value. Send a whole number like <code>3</code>."
                ), reply_markup={"inline_keyboard": [[{"text": "Cancel", "callback_data": f"ustk_price_{_country_cb_token(key)}", "style": "danger"}]]})
            del user_states[chat_id]
            del temp_data[chat_id]
            return
            ...
            if srv:
                ...
                edit_message(chat_id, msg_id, render_body_text(f"📝 Send reward amount (USDT) for <b>{srv}</b>:"), reply_markup=cancel_kb)
            else:
                del user_states[chat_id]
                del temp_data[chat_id]
            return
            ...
            wait_msg = send_message(chat_id, render_body_text("⌛ <i>Number Is Being Assigned Please Wait.</i>"))
            ...
            def _do_custom_fetch(chat_id, query, range_text, wait_msg_id):
                ...
                _custom_iso = None
                for _plen in range(min(3, len(query)), 0, -1):
                    _candidate = PHONE_CODE_TO_ISO.get(query[:_plen])
                    if _candidate:
                        _custom_iso = _candidate
                        break
                if _custom_iso and not _country_is_enabled(_custom_iso):
                    if wait_msg_id:
                        try: delete_message(chat_id, wait_msg_id)
                        except: pass
                    send_message(chat_id, render_body_text(f"❌ {_country_display(_custom_iso)} is currently OFF."), reply_markup=main_menu(chat_id))
                    return
                ...
                for b_id, b_data in number_batches.items():
                    for idx, n_obj in enumerate(b_data["numbers"]):
                        if (n_obj["num"].replace("+", "").startswith(query)
                                and _country_is_enabled(b_data.get("country"))
                                and chat_id not in n_obj.get("used_by", [])):
                            found_indices.append((b_id, idx))

                req_count = _country_num_req(_custom_iso) if _custom_iso else max(1, int(bot_settings.get("num_req", 1)))
                assigned_nums = []
                ...
                for num in assigned_nums:
                    ...
                    kb.append([_number_button(num, WAITING_NUMBER_EMOJI_ID, cc_visible=True)])

                kb.append(_add_cc_control_row())
                kb.append([{"text": "𝐂𝐡𝐚𝐧𝐠𝐞 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5377774889723798543", "callback_data": f"c_custom_{range_text}", "style": "success"},
                           {"text": "𝐎𝐓𝐏 𝐆𝐫𝐨𝐮𝐩", "icon_custom_emoji_id": "6235727781427155894", "url": bot_settings.get("otp_link", "https://t.me"), "style": "primary"}])
                ...
                txt = render_body_text(
                    f"{PEM['ok']} <b>Your Number Taken Successfully</b>\n\n"
                    f"🎯 <b>Range:</b> {range_text}"
                )
                try:
                    edit_message(chat_id, wait_msg_id, txt, reply_markup={"inline_keyboard": kb})
                    user_active_sessions[chat_id] = {"msg_id": wait_msg_id, "nums": assigned_nums, "service": "Custom", "country": range_text, "reply_markup": {"inline_keyboard": kb}, "cc_visible": True}
                except:
                    if wait_msg_id:
                        try: delete_message(chat_id, wait_msg_id)
                        except: pass
                    ...
                    if new_msg_id:
                        user_active_sessions[chat_id] = {"msg_id": new_msg_id, "nums": assigned_nums, "service": "Custom", "country": range_text, "reply_markup": {"inline_keyboard": kb}, "cc_visible": True}
            ...
            for _plen in range(min(3, len(query)), 0, -1):
                _candidate = PHONE_CODE_TO_ISO.get(query[:_plen])
                if _candidate:
                    _search_iso = _candidate
                    break
            if _search_iso and not _country_is_enabled(_search_iso):
                send_message(chat_id, render_body_text(
                    f"❌ {_country_display(_search_iso)} is currently OFF."
            ...
            if not found_indices:
                ...
                req_count = _country_num_req(_search_iso) if _search_iso else max(1, int(bot_settings.get("num_req", 1)))
            ...
            kb.append(_add_cc_control_row())
            kb.append([{"text": "𝐂𝐡𝐚𝐧𝐠𝐞 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5377774889723798543", "callback_data": f"c_n_s_{query}", "style": "success"},
                       {"text": "𝐎𝐓𝐏 𝐆𝐫𝐨𝐮𝐩", "icon_custom_emoji_id": "6235727781427155894", "url": bot_settings["otp_link"], "style": "primary"}])
            ...
            search_header = render_body_text(
                f"{PEM['ok']} <b>Your Number Taken Successfully</b>\n\n"
                f"🔍 <b>Your Service :</b> +{query}"
            )
            if wait_msg_id:
                edit_message(chat_id, wait_msg_id, search_header, reply_markup={"inline_keyboard": kb})
                user_active_sessions[chat_id] = {"msg_id": wait_msg_id, "nums": fetched_nums, "reply_markup": {"inline_keyboard": kb}, "cc_visible": True}
            else:
                msg_res = send_message(chat_id, search_header, reply_markup={"inline_keyboard": kb})
                if msg_res and "result" in msg_res:
                    user_active_sessions[chat_id] = {"msg_id": msg_res["result"]["message_id"], "nums": fetched_nums, "reply_markup": {"inline_keyboard": kb}, "cc_visible": True}
            return
            ...
            admin_txt = render_body_text(
                ...
                f"━━━━━━━━━━━━━━━━━━━━━━\n"
                f"👤 <b>User Name :</b> <a href='tg://user?id={chat_id}'>{safe_name}</a>\n"
            ...
            send_message(chat_id, render_body_text(
                ...
                f"📩 Your Message Has Reached The Admin\n"
                f"🔔 You Will Be Notified Once The Admin Replies"
            ), reply_markup=main_menu(chat_id))
            if chat_id in user_states: del user_states[chat_id]
            if chat_id in temp_data: del temp_data[chat_id]
            return
            ...
            # Save the user's Telegram bio until the user confirms the withdrawal.
            user_bio = ""
            try:
                chat_info = api_call("getChat", {"chat_id": chat_id})
                if isinstance(chat_info, dict) and chat_info.get("ok"):
                    user_bio = str(chat_info.get("result", {}).get("bio", "") or "").strip()
            except Exception:
                user_bio = ""

            # Do NOT deduct balance or notify admin yet. Wait for Confirm.
            temp_data[chat_id]["withdraw_number"] = number
            temp_data[chat_id]["withdraw_bio"] = user_bio
            temp_data[chat_id]["withdraw_full_name"] = full_name
            user_states[chat_id] = "withdraw_confirmation"

            confirm_kb = {
                "inline_keyboard": [[
                    {
                        "text": "Confirm",
                        "icon_custom_emoji_id": "5352694861990501856",
                    ...
                    },
                    {
                        ...
                        "callback_data": "cancel_withdraw_confirm",
                        "style": "danger"
                    }
                ]]
            }
            confirm_text = f"""╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮
   {PEM['ok']}    Confirm Withdrawal Request
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯

💰 <b>Amount :</b> {amount} USDT
🏦 <b>Method :</b> {method}
📞 <b>Number :</b> <code>{html.escape(number)}</code>

━━━━━━━━━━━━━━━━━━━━━━━━━━━━
⏳ <b>Status :</b> Waiting For Confirmation

📌 Please Confirm Your Withdrawal Request Below.
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━╯"""

            if msg_id_to_edit:
                edit_message(chat_id, msg_id_to_edit, render_body_text(confirm_text), reply_markup=kb)
            else:
                send_message(chat_id, render_body_text(confirm_text), reply_markup=kb)
    ...
    if text.startswith("/start"):
        get_user(chat_id)
        if not has_selected_language(chat_id):
            send_language_selector(chat_id)
            return
        
        # --- PROCESS PENDING REFERRAL ---
        # --- PROCESS PENDING REFERRAL (works with or without Firestore) ---
        ...
        # Developer button — shown directly below the /start welcome message.
        kb.append([{
            "text": " 👨‍💻 Developer",
            "url": "https://t.me/roman_khan_admin",
            "style": "primary"
        }])
...
┃  📊 Total OTP Sent   : <b>{u_data.get('total_otps', 0)}</b>
┃  🫂 Total Referrals    : <b>{u_data.get('total_refers', 0)}</b>
┣━━━━━━━━━━━━━━━━━━━━━━━┫
┃  🔐 Minimum Withdraw   : <b>{bot_settings['min_withdraw']} USDT</b>
╰━━━━━━━━━━━━━━━━━━━━━━━╯""")

        bal_kb = []
        if bot_settings["withdraw_on"]:
            for m in bot_settings["w_methods"]:
                bal_kb.append([{"text": f"Withdraw {m.strip()}", "callback_data": f"sel_wm_{m.strip()}", "style": "primary"}])
        else:
        ...
        nexus_srvs = set(bot_settings.get("nexus_services", {}).keys())
        all_services = local_srvs.union(zenex_srvs).union(stex_srvs).union(voltx_srvs).union(nexus_srvs)
        ...
        if not all_services:
            ...
            kb = []
            _srv_btns = []
            _visible_services = set()
            for s in all_services:
                _service_countries = set()
                for b in number_batches.values():
                    if b.get("service") == s and b.get("numbers"):
                        _service_countries.add(b.get("country"))
                for _map_name in ("zenex_services", "stex_services", "voltx_services", "nexus_services"):
                    _service_countries.update(bot_settings.get(_map_name, {}).get(s, {}).keys())
                if any(_country_is_enabled(c) for c in _service_countries) or not _service_countries:
                    _visible_services.add(s)
            all_services = _visible_services
                ...
                for app_key, app_data in apps_db.items():
                    if s.upper() == app_key or s.upper() in app_key or app_key in s.upper():
                        if "id" in app_data:
                            ...
                            break
                _srv_btns.append({"text": f"{s}", "icon_custom_emoji_id": emoji_id, "callback_data": f"g_s_{s}", "style": "primary"})
            for service_button in _srv_btns:
                kb.append([service_button])
    ...
    elif text == "2F CODE" or text == "2FA ONLINE" or text == "🔐 2FA ONLINE":
        txt = f"━━━━━━━━━━━━━━━\n《 🔐 <b>2F CODE</b> 》\n━━━━━━━━━━━━━━━\n<i>নিচের যেকোনো একটি সেবা বেছে নিন।</i>\n━━━━━━━━━━━━━━━"
        kb = [
            [{"text": "2FA CODE", "icon_custom_emoji_id": "5353022963132174959", "callback_data": "gen_2fa", "style": "success"}],
            [{"text": "RANDOM NAME", "icon_custom_emoji_id": "5352552689983067014", "callback_data": "rand_name", "style": "primary"}],
            [{"text": "Close", "icon_custom_emoji_id": "5420130255174145507", "callback_data": "close_msg", "style": "danger"}]
        ]
        send_message(chat_id, render_body_text(txt), reply_markup={"inline_keyboard": kb})

    elif text in ("LEADERBOARD", "Leaderboard"):
        # ── Public Top-5 OTP Leaderboard ──────────────────────────────────
        users_data = []
        try:
            if db:
                users = db.collection('users').order_by("total_otps", direction="DESCENDING").stream()
                for u in users:
                    d = u.to_dict()
                    otps = int(d.get("total_otps", 0) or 0)
                    if otps <= 0: continue

                    first_name = str(d.get("first_name") or "").strip()
                    last_name = str(d.get("last_name") or "").strip()

                    # If old Firestore records do not have names, try Telegram.
                    if not first_name and not last_name:
                        try:
                            r = requests.get(f"{BASE_URL}/getChat", params={"chat_id": str(u.id)}, timeout=5)
                            if r.ok and r.json().get("ok"):
                                cd = r.json().get("result", {})
                                first_name = str(cd.get("first_name") or "").strip()
                                last_name = str(cd.get("last_name") or "").strip()
                                if first_name or last_name:
                                    d["first_name"] = first_name
                                    d["last_name"] = last_name
                                    try:
                                        db.collection('users').document(str(u.id)).update({
                    ...
                    users_data.append((str(u.id), d, otps))

            # ── Local fallback ──────────────────────────────────────────────
            if not users_data:
                sorted_users = sorted(
                    _local_users.items(),
                    key=lambda x: x[1].get("total_otps", 0),
                    reverse=True
                )
                for uid_str, d in sorted_users:
                    otps = int(d.get("total_otps", 0) or 0)
                    if otps <= 0: continue
                    users_data.append((str(uid_str), d, otps))

            # ── Current User Rank ───────────────────────────────────────────
            your_rank = "N/A"
            for rank, (uid, d, otps) in enumerate(users_data, 1):
                if uid == str(chat_id):
                    your_rank = rank
                    break
            ...
            medals = ["🥇", "🥈", "🥉", "🏅", "🏅"]
            rows = ""
            for rank, (uid, d, otps) in enumerate(users_data[:5], 1):
                first_name = str(d.get("first_name") or "").strip()
                last_name = str(d.get("last_name") or "").strip()
                name = f"{first_name} {last_name}".strip() or str(d.get("name") or "User").strip()
                rows += f"<b>#{rank}</b> {medals[rank - 1]} <b>{html.escape(name)}</b> — <b>{otps} OTPs</b>\n"

        except Exception as _e:
            rows = f"└ <i>Error: {html.escape(str(_e))}</i>\n"
            your_rank = "N/A"

        if not rows:
            rows = "└ <i>এখনো কোনো OTP receive হয়নি।</i>\n"

        txt = (
            f"🏆 <b>Leaderboard — Top 5 Users by OTPs</b>\n\n"
            f"{rows}\n"
            f"👤 <b>Your Rank: #{your_rank}</b>\n\n"
        )
        kb = {"inline_keyboard": [
            [{"text": "🔎 Search Number", "callback_data": "lb_search_number", "style": "primary"}],
            [{"text": "🔄 Refresh", "icon_custom_emoji_id": "5420155432272438703", "callback_data": "pub_lb_refresh", "style": "success"}],
            [{"text": "Close", "icon_custom_emoji_id": "5420130255174145507", "callback_data": "close_msg", "style": "danger"}]
        ]}
...
def expire_previous_number(chat_id):
    if chat_id in user_active_sessions:
        ...
        for num in nums:
            ...
            num_plus  = '+' + num_clean
            for d in (batch_assigned_numbers, stex_assigned_numbers, voltx_assigned_numbers, zenex_assigned_numbers, nexus_assigned_numbers):
                d.pop(num, None)
...
# ==========================================
# Number Session UI — Add/Remove Country Code
# ==========================================
def _clean_number_for_ui(value):
    """Normalize a phone number for UI matching without changing stored assignment data."""
    return re.sub(r"\D", "", str(value or ""))


def _country_code_for_number(value):
    """Return the international country calling code for a phone number."""
    clean = _clean_number_for_ui(value)
    if not clean:
        return ""
    for code in sorted(PHONE_CODE_TO_ISO.keys(), key=len, reverse=True):
        if clean.startswith(code):
            return code
    for code in sorted(bot_settings.get("premium_flags", {}).keys(), key=len, reverse=True):
        code = _clean_number_for_ui(code)
        if code and clean.startswith(code):
            return code
    return ""


def _number_display(value, cc_visible=True):
    """Remove or restore '+' plus the international country calling code."""
    clean = _clean_number_for_ui(value)
    if not clean:
        return str(value or "").strip()
    country_code = _country_code_for_number(clean)
    national = clean[len(country_code):] if country_code and clean.startswith(country_code) else clean
    if cc_visible:
        return f"+{country_code}{national}" if country_code else f"+{clean}"
    return national


def _number_button(num, emoji_id, cc_visible=True):
    """Build a copyable number button with CC hidden/shown according to state."""
    display = _number_display(num, cc_visible=cc_visible)
    return {
        "text": display,
        "icon_custom_emoji_id": emoji_id or WAITING_NUMBER_EMOJI_ID,
        "copy_text": {"text": display},
        "style": "primary"
    }


def _add_cc_control_row():
    return [{
        "text": "➖ 𝐑𝐞𝐦𝐨𝐯𝐞 𝐂𝐂",
...
def _change_country_row(callback_data):
    return [{
        "text": "𝐂𝐡𝐚𝐧𝐠𝐞 𝐂𝐨𝐮𝐧𝐭𝐫𝐲",
        "icon_custom_emoji_id": "5780471598922337683",
        "callback_data": callback_data,
        "style": "primary"
    }]


def _four_number_control_rows(change_number_cb, change_country_cb, otp_url):
    """Exactly four stacked controls used under the assigned number(s)."""
    return [
        _add_cc_control_row(),
        [{"text": "𝐂𝐡𝐚𝐧𝐠𝐞 𝐍𝐮𝐦𝐛𝐞𝐫", "icon_custom_emoji_id": "5377774889723798543", "callback_data": change_number_cb, "style": "success"}],
        [{"text": "𝐂𝐡𝐚𝐧𝐠𝐞 𝐂𝐨𝐮𝐧𝐭𝐫𝐲", "icon_custom_emoji_id": "5780471598922337683", "callback_data": change_country_cb, "style": "primary"}],
        [{"text": "𝐎𝐓𝐏 𝐆𝐫𝐨𝐮𝐩", "icon_custom_emoji_id": "6235727781427155894", "url": otp_url or "https://t.me/", "style": "primary"}],
    ]


def _toggle_cc_for_session(chat_id, msg_id, callback_id):
    """Toggle CC in the displayed/copyable number without changing stored numbers."""
    session = user_active_sessions.get(chat_id)
    if not session:
        answer_callback(callback_id, "❌ Number session expired. Please get a new number.", show_alert=True)
        return

    current_visible = bool(session.get("cc_visible", False))
    new_visible = not current_visible
    original_numbers = [str(n or "") for n in session.get("nums", [])]
    markup = session.get("reply_markup") or {"inline_keyboard": []}
    rows = markup.get("inline_keyboard", [])

    # Match both the full international number and the national-only display.
    number_lookup = {}
    for original in original_numbers:
        clean = _clean_number_for_ui(original)
        if not clean:
            continue
        for candidate in (clean, _number_display(original, True), _number_display(original, False)):
            candidate_clean = _clean_number_for_ui(candidate)
            if candidate_clean:
                number_lookup[candidate_clean] = original
    ...
    for row in rows:
        ...
        for button in row:
            b = dict(button)
            candidates = [str(b.get("text", ""))]
            if isinstance(b.get("copy_text"), dict):
                candidates.append(str(b["copy_text"].get("text", "")))

            matched_original = None
            for candidate in candidates:
                candidate_clean = _clean_number_for_ui(candidate)
                if candidate_clean in number_lookup:
                    matched_original = number_lookup[candidate_clean]
                    break

            if matched_original is not None:
                display = _number_display(matched_original, cc_visible=new_visible)
                b["text"] = display
                b["copy_text"] = {"text": display}
                changed = True

            if b.get("callback_data") == "toggle_cc":
                b["text"] = "➖ 𝐑𝐞𝐦𝐨𝐯𝐞 𝐂𝐂" if new_visible else "➕ 𝐀𝐝𝐝 𝐂𝐂"
                b.pop("icon_custom_emoji_id", None)
                b["style"] = "danger" if new_visible else "success"
            new_row.append(b)
        new_rows.append(new_row)

    new_markup = {"inline_keyboard": new_rows}
    if changed or new_visible != current_visible:
        result = edit_message_reply_markup(chat_id, msg_id, new_markup)
        if result and result.get("ok"):
            session["reply_markup"] = new_markup
            session["cc_visible"] = new_visible
            answer_callback(callback_id, "✅ Country code added." if new_visible else "✅ Country code removed.", show_alert=False)
        else:
            answer_callback(callback_id, "⚠️ Could not update the number display. Please try again.", show_alert=True)
    else:
        session["reply_markup"] = new_markup
        session["cc_visible"] = new_visible
...
# ==========================================
def _mask_withdraw_address(value, hide_count=None):
    """Mask public user information while keeping the beginning/end visible."""
    raw = str(value or "").strip()
    if not raw:
        return raw

    # Short user info / phone / Binance ID: hide 3 characters.
    # Long crypto/payment addresses: hide 12 characters from the middle.
    if hide_count is None:
        hide_count = 12 if len(raw) > 24 else 3

    if len(raw) <= hide_count + 2:
        return raw

    left = max(1, (len(raw) - hide_count) // 2)
    right = len(raw) - hide_count - left
    return f"{raw[:left]}{'•' * hide_count}{raw[-right:] if right else ''}"


def _generate_public_tx_hash(req_data):
    """Return a short 36-character transaction hash for the public withdrawal post."""
    tx_hash = str(req_data.get("tx_hash", "")).strip()
    if not tx_hash:
        tx_hash = uuid.uuid4().hex + uuid.uuid4().hex
        req_data["tx_hash"] = tx_hash
    return tx_hash[:36]


def _publish_approved_withdrawal(req_data):
    """Publish an approved withdrawal to the configured public channel/group."""
    target = str(bot_settings.get("w_public_channel", "")).strip()
    if not target:
        return False, "W. PUBLIC is not configured in ROMAN CONTROL."
    # Accept Telegram chat IDs (-100...) or public @usernames only.
    if target.startswith("https://t.me/") or target.startswith("http://t.me/"):
        target = "@" + target.rstrip("/").split("/")[-1].split("?")[0].lstrip("@")
    if target.startswith("t.me/"):
        target = "@" + target.rstrip("/").split("/")[-1].split("?")[0].lstrip("@")

    amount = req_data.get("amount", 0)
    method = str(req_data.get("method", "USDT BEP20")).strip() or "USDT BEP20"
    # Prefer the latest Telegram bio when available; otherwise use the
    # withdrawal number/address supplied by the user.
    public_value = str(req_data.get("bio", "")).strip() or str(req_data.get("number", "")).strip()
    if len(public_value) > 24:
        address = _mask_withdraw_address(public_value, 12)
    else:
        address = _mask_withdraw_address(public_value, 3)
    full_name = html.escape(str(req_data.get("full_name", "User")).strip() or "User")
    tx_hash = _generate_public_tx_hash(req_data)

    try:
        amount_text = f"{float(amount):.1f} USDT"
    except (TypeError, ValueError):
        amount_text = f"{html.escape(str(amount))} USDT"

    public_text = (
        f"💰 <b>{full_name} Payment Completed</b> ✅\n\n"
        f"━━━━━━━━━━━━━━━━━━━━━━━━\n"
        f"💰 <b>Amount:</b> {amount_text}\n"
        f"💰 <b>Withdraw:</b> {html.escape(method)}\n"
        f"✍️ <b>Address:</b> <code>{html.escape(address)}</code>\n\n"
    ...
    if bot_username:
        button_url = f"https://t.me/{bot_username}?start=get_number"
    else:
        button_url = "https://t.me/"

    public_kb = {"inline_keyboard": [[
        {"text": "📞 Get Number", "url": button_url, "style": "primary"}
    ]]}

    # Use the Telegram API directly here. This avoids translating/re-formatting
    # the public announcement based on the channel/group chat ID.
    payload = {
        "chat_id": target,
        "text": _premium_visible_text(public_text),
        "parse_mode": "HTML",
        "disable_web_page_preview": True,
        "reply_markup": _bold_keyboard_markup(public_kb),
    }
    ...
    if isinstance(result, dict):
        error = result.get("description") or result.get("error_code") or "Telegram API rejected the message."
    else:
        error = "No valid response from Telegram API."
...
def handle_callback(call):
    ...
    if not data.startswith("test_p_conn_") and not data.startswith("c_n_") and not data.startswith("g_c_") and data != "toggle_cc":
    ...
    if data == "check_fj":
        if check_force_join(chat_id):
            try:
                udata = get_user(chat_id)
                udata["verified"] = True
                _cache_set(chat_id, udata)
                if db:
                    try: db.collection("users").document(str(chat_id)).update({"verified": True})
                    except Exception: pass
                else:
                    _get_local_user(chat_id)["verified"] = True
                    _save_users_local()
            except Exception:
                pass
    ...
    # Language selection is intentionally available only after Force-Join passes.
    if data.startswith("lang_"):
        lang = data.replace("lang_", "", 1).lower()
        if lang not in SUPPORTED_LANGUAGES:
            answer_callback(call["id"], "Invalid language.", show_alert=True)
            return
        if set_user_language(chat_id, lang):
            answer_callback(call["id"], f"{SUPPORTED_LANGUAGES[lang]['name']} selected.")
            delete_message(chat_id, msg_id)
            send_message(chat_id, "🌐 <b>Language selected successfully.</b>")
            send_message(chat_id, "⚙️ Navigation Menu:", reply_markup=main_menu(chat_id))
        else:
            answer_callback(call["id"], "Could not save language. Please try again.", show_alert=True)
        return
    ...
    if data == "close_msg":
        ...
        edit_message(chat_id, msg_id, render_body_text(
            f"💬 <b>Respond To Query</b>\n"
            f"━━━━━━━━━━━━━━━━━━━━━\n"
            f"🆔 Telegram ID: <code>{target_uid}</code>\n"
            f"━━━━━━━━━━━━━━━━━━━━━\n"
            f"📝 Enter Your Message Below:"
        ...
        first_names = [
            "Arif", "Sakib", "Raihan", "Imran", "Rahim", "Karim", "Hasan", "Nabil",
            "Farhan", "Tanvir", "Mahdi", "Shihab", "Jubair", "Rashed", "Zahid",
            "Mehedi", "Shuvo", "Rakib", "Tuhin", "Asif", "Rifat", "Sadat", "Naeem",
            "Sumon", "Limon", "Milon", "Nahid", "Yusuf", "Bashir", "Anwar",
            "Adnan", "Shahin", "Sayem", "Fahim", "Ripon", "Mamun", "Babu", "Robin",
            "Siam", "Fuad", "Ridoy", "Shohan", "Alif", "Anik", "Rony", "Tanjim",
            "Sohel", "Jewel", "Dulal", "Riaz", "Sabbir", "Maruf", "Emon", "Tahmid"
        ]
        last_names = [
            "Ahmed", "Islam", "Hossain", "Rahman", "Khan", "Ali", "Mia", "Sarkar",
            "Chowdhury", "Alam", "Uddin", "Sheikh", "Bhuiyan", "Mondal", "Dey",
            "Paul", "Roy", "Das", "Biswas", "Saha", "Nath", "Ghosh", "Barua",
            "Talukdar", "Hawlader", "Majumder", "Sikder", "Mollah", "Bepari", "Gazi",
            "Shikder", "Fakir", "Barik", "Patowary", "Chandra", "Kumar", "Gain",
            "Halder", "Mandal", "Karmaker", "Nandi", "Sutradhar", "Chakraborty"
        ]
        rand_first = random.choice(first_names)
        rand_last  = random.choice(last_names)
        full_rand_name = f"{rand_first} {rand_last}"
        admin_pass = bot_settings.get("rand_name_pass", "")
        pass_line = f"\n🔑 <b>PASS:</b> <code>{admin_pass}</code>" if admin_pass else ""
        txt = (
            f"━━━━━━━━━━━━━━━\n"
            f"《 {PEM['star']} <b>RANDOM NAME</b> 》\n"
            f"━━━━━━━━━━━━━━━\n"
            f"👤 <b>NAME:</b> <code>{full_rand_name}</code>"
            f"{pass_line}\n"
            f"━━━━━━━━━━━━━━━"
        )
        kb = [
            [{"text": full_rand_name, "icon_custom_emoji_id": "5352861489541714456", "copy_text": {"text": full_rand_name}, "style": "success"}],
            [{"text": "New Name", "icon_custom_emoji_id": "5377774889723798543", "callback_data": "rand_name", "style": "primary"}],
            [{"text": "Back", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "back_to_2fmenu", "style": "danger"}]
        ]
        if admin_pass:
            kb.insert(1, [{"text": admin_pass, "icon_custom_emoji_id": "5353022963132174959", "copy_text": {"text": admin_pass}, "style": "primary"}])
        edit_message(chat_id, msg_id, render_body_text(txt), reply_markup={"inline_keyboard": kb})
        answer_callback(call["id"])

    elif data == "back_to_2fmenu":
        txt = f"━━━━━━━━━━━━━━━\n《 🔐 <b>2F CODE</b> 》\n━━━━━━━━━━━━━━━\n<i>নিচের যেকোনো একটি সেবা বেছে নিন।</i>\n━━━━━━━━━━━━━━━"
        kb = [
            [{"text": "2FA CODE", "icon_custom_emoji_id": "5353022963132174959", "callback_data": "gen_2fa", "style": "success"}],
            [{"text": "RANDOM NAME", "icon_custom_emoji_id": "5352552689983067014", "callback_data": "rand_name", "style": "primary"}],
        ...
        answer_callback(call["id"], "🔎 Search Number", show_alert=False)

    elif data == "pub_lb_refresh":
    ...
    # --- User Management Flows Integration ---
        ...
        if not rates:
            ...
            for uid, rate in rates.items():
                lines.append(f"👤 <code>{uid}</code> → <b>{rate} USDT</b>")
    ...
    # --- Menu Design Integration ---
        ...
        edit_message(chat_id, msg_id, render_body_text(f"{PEM['ok']} Method Buy: {method}\n💰 Available Balance : {bal} USDT\n\n📝 Enter Your Withdrawal Amount Minimum. {min_w} USDT."), reply_markup=get_cancel_kb())
        answer_callback(call["id"])
    ...
    elif data == "tog_panel_alert":
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        bot_settings["panel_alert_on"] = not bot_settings.get("panel_alert_on", True)
        save_db()
        state_str = "🟢 চালু" if bot_settings["panel_alert_on"] else "🔴 বন্ধ"
        answer_callback(call["id"], f"Panel Alert {state_str} হয়েছে!", show_alert=True)
        handle_callback({"message": {"chat": {"id": chat_id}, "message_id": msg_id}, "data": "system_settings", "id": "internal"})

    elif data == "tog_user_otp_notify":
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        bot_settings["user_otp_notify"] = not bot_settings.get("user_otp_notify", True)
        save_db()
        state_str = "🟢 চালু" if bot_settings["user_otp_notify"] else "🔴 বন্ধ"
        answer_callback(call["id"], f"User OTP Notify {state_str} হয়েছে!", show_alert=True)
        handle_callback({"message": {"chat": {"id": chat_id}, "message_id": msg_id}, "data": "system_settings", "id": "internal"})

    elif data == "tog_no_match_alert":
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        bot_settings["no_match_alert_on"] = not bot_settings.get("no_match_alert_on", True)
        save_db()
        state_str = "🟢 চালু" if bot_settings["no_match_alert_on"] else "🔴 বন্ধ"
        answer_callback(call["id"], f"No-Match Alert {state_str} হয়েছে!", show_alert=True)
        handle_callback({"message": {"chat": {"id": chat_id}, "message_id": msg_id}, "data": "system_settings", "id": "internal"})
    ...
    # ══════════════════════════════════════════
    # 🔷 Nexus-X Panel Callbacks (REST Bearer API)
    # ══════════════════════════════════════════
    elif data == "nexus_control":
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        key_count = len(bot_settings.get("nexus_keys", []))
        status_txt = "🟢 RUNNING" if bot_settings.get("nexus_panel_on") else "🔴 STOPPED"
        edit_message(chat_id, msg_id, render_body_text(
            f"🔷 <b>Nexus-X Panel</b>\n\n"
            f"📡 <b>Status:</b> {status_txt}\n"
            f"🔑 <b>API Keys:</b> {key_count}\n\n"
            f"Nexus-X REST API দিয়ে OTP collect করে।\n"
            f"Example Key: <code>nx_AgYVC5ts1jvegsPRowe4Nu0MajvuC3DPw...</code>"
        ), reply_markup=nexus_control_keyboard())

    elif data == "nexus_toggle":
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        if not bot_settings.get("nexus_keys", []):
            answer_callback(call["id"], "❌ আগে API Key যোগ করো!", show_alert=True); return
        bot_settings["nexus_panel_on"] = not bot_settings.get("nexus_panel_on", False)
        save_db()
        state_str = "🟢 চালু" if bot_settings["nexus_panel_on"] else "🔴 বন্ধ"
        answer_callback(call["id"], f"🔷 Nexus-X Panel {state_str} হয়েছে!", show_alert=True)
        handle_callback({"message": {"chat": {"id": chat_id}, "message_id": msg_id}, "data": "nexus_control", "id": "internal"})

    elif data == "nexus_add_key":
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        user_states[chat_id] = "wait_for_add_nexus_key"
        temp_data[chat_id] = {"msg_id": msg_id}
        edit_message(chat_id, msg_id, render_body_text(
            "🔑 <b>Nexus-X API Key</b>\n\n"
            "📝 Nexus-X panel থেকে পাওয়া API key পাঠান:\n\n"
            "Example: <code>nx_AgYVC5ts1jvegsPRowe4Nu0MajvuC3DPwZmttQ</code>"
        ), reply_markup={"inline_keyboard": [[{"text": "Cancel", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "nexus_control", "style": "danger"}]]})

    elif data == "nexus_view_keys":
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        keys = bot_settings.get("nexus_keys", [])
        kb = []
        if not keys:
            kb.append([{"text": "কোনো Key নেই", "callback_data": "ignore", "style": "primary"}])
        for idx, key in enumerate(keys):
            masked = key[:8] + "..." + key[-4:] if len(key) > 14 else key
            kb.append([{"text": f"🗑 Delete {masked}", "icon_custom_emoji_id": "5420130255174145507", "callback_data": f"del_nexus_{idx}", "style": "danger"}])
        kb.append([{"text": "Back", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "nexus_control", "style": "primary"}])
        edit_message(chat_id, msg_id, render_body_text(f"🔷 <b>Nexus-X API Keys ({len(keys)}):</b>\nDelete করতে চাইলে বাটনে চাপুন:"), reply_markup={"inline_keyboard": kb})

    elif data.startswith("del_nexus_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        try:
            idx = int(data[len("del_nexus_"):])
        except ValueError:
            answer_callback(call["id"], "❌ Invalid index!", show_alert=True); return
        keys = bot_settings.get("nexus_keys", [])
        if 0 <= idx < len(keys):
            del keys[idx]
            save_db()
            answer_callback(call["id"], "✅ Key Deleted!", show_alert=True)
        handle_callback({"message": {"chat": {"id": chat_id}, "message_id": msg_id}, "data": "nexus_view_keys", "id": "internal"})

    elif data == "nexus_live_test":
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        answer_callback(call["id"], "⌛ Nexus-X API চেক হচ্ছে...", show_alert=False)
        keys = bot_settings.get("nexus_keys", [])
        if not keys:
            edit_message(chat_id, msg_id, render_body_text("❌ কোনো API Key নেই! প্রথমে key যোগ করুন।"), reply_markup=nexus_control_keyboard())
            return
        results = []
        for api_key in keys[:2]:
            ...
            try:
                ...
                res = requests.get("https://v2.nexus-x.site/api/v1/inbox", headers=headers, timeout=12)
                if res.status_code == 401:
                    results.append(f"🔴 Key <code>{masked}</code>: <b>Unauthorized</b> — Key টি invalid বা expire হয়েছে")
                    continue
                if res.status_code != 200:
                    results.append(f"🔴 Key <code>{masked}</code>: HTTP {res.status_code} error")
                    continue
                try:
                    data_resp = res.json()
                except Exception:
                    results.append(f"🔴 Key <code>{masked}</code>: JSON parse error — Raw: <code>{res.text[:120]}</code>")
                    continue
                items = data_resp if isinstance(data_resp, list) else data_resp.get("data", data_resp.get("items", []))
                if not items:
                    results.append(f"🟡 Key <code>{masked}</code>: সংযোগ OK কিন্তু inbox খালি (কোনো SMS নেই)")
                    continue
                results.append(f"🟢 Key <code>{masked}</code>: <b>{len(items)} records</b> পাওয়া গেছে")
                for i, item in enumerate(items[:3]):
                    num = str(item.get("number", item.get("full_number", ""))).strip()
                    otp_txt = str(item.get("body", item.get("text", item.get("console", ""))))[:60]
                    service = item.get("service", item.get("access", item.get("sid", "?")))
                    results.append(f"  #{i+1} num=<code>{num}</code> | svc={service}\n       msg: <i>{otp_txt}</i>")
            except Exception as e:
                results.append(f"🔴 Key <code>{masked}</code> error: {e}")
        final_txt = render_body_text("🔍 <b>Nexus-X Panel Live Test</b>\n\n" + "\n".join(results))
        edit_message(chat_id, msg_id, final_txt, reply_markup={"inline_keyboard": [[
            {"text": "🔄 আবার Test করুন", "callback_data": "nexus_live_test", "style": "primary"},
            {"text": "Back", "callback_data": "nexus_control", "style": "danger"}
        ]]})

    # ══════════════════════════════════════════
    # 🔷 Nexus-X Services Manager Callbacks
    # ══════════════════════════════════════════
    elif data == "manage_nexus_srv":
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        kb = []
        srvs = bot_settings.get("nexus_services", {})
        apps_db = bot_settings.get("premium_apps", {})
        for srv in srvs:
            emoji_id = "5257969839313526622"
            for app_key, app_data in apps_db.items():
                if srv.upper() == app_key or srv.upper() in app_key or app_key in srv.upper():
                    if "id" in app_data: emoji_id = app_data["id"]; break
            kb.append([{"text": f"{srv}", "icon_custom_emoji_id": emoji_id, "callback_data": f"nxs_srv_{srv}", "style": "primary"}])
        kb.append([{"text": "Add New Service", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "nxs_add_srv", "style": "success"}])
        kb.append([{"text": "Back", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "nexus_control", "style": "danger"}])
        edit_message(chat_id, msg_id, render_body_text("🔷 <b>Nexus Services Manager</b>\nManage your Nexus API-based services below:"), reply_markup={"inline_keyboard": kb})

    elif data == "nxs_add_srv":
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        user_states[chat_id] = "wait_nxs_srv_name"
        temp_data[chat_id] = {"msg_id": msg_id}
        edit_message(chat_id, msg_id, render_body_text("📝 Enter Service Name (e.g. TELEGRAM):"), reply_markup=get_cancel_kb())

    elif data.startswith("nxs_srv_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        srv = data.replace("nxs_srv_", "")
        kb = []
        countries = bot_settings.get("nexus_services", {}).get(srv, {})
        flags_db = bot_settings.get("premium_flags", {})
        for c in countries:
            emoji_id = "5780471598922337683"
            for flag_code, flag_data in flags_db.items():
                ...
                if c.upper() == iso or c.upper() == name or c.upper() in name or name in c.upper():
                    if "id" in flag_data: emoji_id = flag_data["id"]; break
            kb.append([{"text": f"{c} ({len(countries[c])} Ranges)", "icon_custom_emoji_id": emoji_id, "callback_data": f"nxs_cnt_{srv}_{c}", "style": "primary"}])
        kb.append([{"text": "Add Country", "icon_custom_emoji_id": "5420323438508155202", "callback_data": f"nxs_add_cnt_{srv}", "style": "success"}])
        kb.append([{"text": "Delete Service", "icon_custom_emoji_id": "5422557736330106570", "callback_data": f"nxs_del_srv_{srv}", "style": "danger"}])
        kb.append([{"text": "Back", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "manage_nexus_srv", "style": "primary"}])
        edit_message(chat_id, msg_id, render_body_text(f"📂 <b>Nexus Service: {srv}</b>\nManage countries for this service:"), reply_markup={"inline_keyboard": kb})

    elif data.startswith("nxs_add_cnt_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        srv = data.replace("nxs_add_cnt_", "")
        user_states[chat_id] = "wait_nxs_cnt_name"
        temp_data[chat_id] = {"msg_id": msg_id, "srv": srv}
        edit_message(chat_id, msg_id, render_body_text(f"🌍 Enter Country Name for <b>{srv}</b> (e.g. BD, INDIA):"), reply_markup=get_cancel_kb())

    elif data.startswith("nxs_del_srv_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        srv = data.replace("nxs_del_srv_", "")
        if srv in bot_settings.get("nexus_services", {}): del bot_settings["nexus_services"][srv]
        save_db()
        answer_callback(call["id"], f"✅ Service {srv} deleted!", show_alert=True)
        handle_callback({"message": {"chat": {"id": chat_id}, "message_id": msg_id}, "data": "manage_nexus_srv", "id": "internal"})

    elif data.startswith("nxs_cnt_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        parts = data.split("_")
        srv, cnt = parts[2], parts[3]
        ranges = bot_settings.get("nexus_services", {}).get(srv, {}).get(cnt, [])
        kb = []
        row = []
        for r in ranges:
            row.append({"text": f"Delete {r}", "icon_custom_emoji_id": "5420130255174145507", "callback_data": f"nxs_dr_{srv}_{cnt}_{r}", "style": "danger"})
            if len(row) == 2: kb.append(row); row = []
        if row: kb.append(row)
        kb.append([{"text": "Add Range", "icon_custom_emoji_id": "5420323438508155202", "callback_data": f"nxs_addr_{srv}_{cnt}", "style": "success"}])
        kb.append([{"text": "Delete Entire Country", "icon_custom_emoji_id": "5422557736330106570", "callback_data": f"nxs_del_cnt_{srv}_{cnt}", "style": "danger"}])
        kb.append([{"text": "Back", "icon_custom_emoji_id": "5267490665117275176", "callback_data": f"nxs_srv_{srv}", "style": "primary"}])
        txt = f"📍 <b>Nexus Service: {srv} | Country: {cnt}</b>\n\n<b>Total Ranges:</b> {len(ranges)}\n<i>Click on a range to delete it, or add a new one.</i>"
        edit_message(chat_id, msg_id, render_body_text(txt), reply_markup={"inline_keyboard": kb})

    elif data.startswith("nxs_addr_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        parts = data.split("_")
        srv, cnt = parts[2], parts[3]
        user_states[chat_id] = "wait_nxs_addr"
        temp_data[chat_id] = {"msg_id": msg_id, "srv": srv, "cnt": cnt}
        edit_message(chat_id, msg_id, render_body_text(f"📝 Send the new Range for <b>{cnt}</b> (e.g. 88017):"), reply_markup={"inline_keyboard": [[{"text": "Cancel", "icon_custom_emoji_id": "5267490665117275176", "callback_data": f"nxs_cnt_{srv}_{cnt}", "style": "danger"}]]})

    elif data.startswith("nxs_dr_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        parts = data.split("_")
        srv, cnt, rng = parts[2], parts[3], parts[4]
        if rng in bot_settings.get("nexus_services", {}).get(srv, {}).get(cnt, []):
            bot_settings["nexus_services"][srv][cnt].remove(rng)
            save_db()
            answer_callback(call["id"], f"✅ Range {rng} deleted!", show_alert=True)
        handle_callback({"message": {"chat": {"id": chat_id}, "message_id": msg_id}, "data": f"nxs_cnt_{srv}_{cnt}", "id": "internal"})

    elif data.startswith("nxs_del_cnt_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "❌ Admin only!", show_alert=True); return
        parts = data.split("_")
        srv, cnt = parts[3], parts[4]
        if cnt in bot_settings.get("nexus_services", {}).get(srv, {}): del bot_settings["nexus_services"][srv][cnt]
        save_db()
        answer_callback(call["id"], f"✅ Country {cnt} deleted!", show_alert=True)
        handle_callback({"message": {"chat": {"id": chat_id}, "message_id": msg_id}, "data": f"nxs_srv_{srv}", "id": "internal"})
        ...
        if not is_admin(chat_id):
            ...
            return
        if chat_id in user_states: del user_states[chat_id]
        edit_message(chat_id, msg_id, update_stock_text(), reply_markup=update_stock_keyboard())

    elif data == "ustk_country_toggle":
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        edit_message(chat_id, msg_id, render_body_text(
            "🟠 <b>COUNTRY ON/OFF</b>\n\nClick a country to toggle.\n\n"
            "OFF করলে user <b>GET NUMBER</b> এবং <b>SEARCH</b> এ ওই country আর দেখাবে/ব্যবহার করতে পারবে।"
        ), reply_markup=_country_toggle_keyboard())

    elif data.startswith("ustk_tog_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        key = _country_from_token(data[len("ustk_tog_"):])
        setting = _country_setting(key)
        setting["enabled"] = not setting.get("enabled", True)
        save_db()
        edit_message(chat_id, msg_id, render_body_text(
            "🟠 <b>COUNTRY ON/OFF</b>\n\nClick a country to toggle.\n\n"
            "OFF করলে user <b>GET NUMBER</b> এবং <b>SEARCH</b> এ ওই country আর দেখাবে/ব্যবহার করতে পারবে।"
        ), reply_markup=_country_toggle_keyboard())
        answer_callback(call["id"], f"{'ON' if setting['enabled'] else 'OFF'}: {_country_display(key)}")

    elif data == "ustk_country_price":
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        if chat_id in user_states: del user_states[chat_id]
        edit_message(chat_id, msg_id, render_body_text(
            "💰 <b>COUNTRY PRICE / NUM REQUEST</b>\n\n"
            "Select country to edit OTP price and per-request number count."
        ), reply_markup=_country_price_keyboard())

    elif data.startswith("ustk_price_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        key = _country_from_token(data[len("ustk_price_"):])
        setting = bot_settings.get("country_settings", {}).get(key, {})
        price = setting.get("price", bot_settings.get("otp_reward", 0))
        req = setting.get("num_req", bot_settings.get("num_req", 1))
        status = "ON 🟢" if _country_is_enabled(key) else "OFF 🟠"
        detail = (
            "💰 <b>COUNTRY PRICE / NUM REQUEST</b>\n\n"
            f"🌍 <b>Country:</b> {_country_display(key)}\n"
            f"📌 <b>Status:</b> {status}\n"
            "━━━━━━━━━━━━━━━━━━━━\n"
            f"💰 <b>OTP Price:</b> ${price}" + (" (global)" if "price" not in setting else " (custom)") + "\n"
            f"📱 <b>NUM/REQ:</b> {req}" + (" (global)" if "num_req" not in setting else " (custom)") + "\n"
            "━━━━━━━━━━━━━━━━━━━━\n"
            "✅ Price change করলে ওই country-এর OTP reward/message-এ apply হবে.\n"
            "✅ NUM/REQ change করলে ওই country-তে প্রতি request কত number দিতে হবে সেট হবে."
        )
        edit_message(chat_id, msg_id, render_body_text(detail), reply_markup=_country_detail_keyboard(key))

    elif data.startswith("ustk_setprice_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        key = _country_from_token(data[len("ustk_setprice_"):])
        user_states[chat_id] = "ustk_set_price"
        temp_data[chat_id] = {"msg_id": msg_id, "country": key}
        current = bot_settings.get("country_settings", {}).get(key, {}).get("price", bot_settings.get("otp_reward", 0))
        edit_message(chat_id, msg_id, render_body_text(
            f"💰 <b>Set OTP Price</b>\n\n🌍 <b>Country:</b> {_country_display(key)}\n"
            f"Current: ${current}\n\nSend new price. Example: <code>0.10</code> or <code>1</code>"
        ), reply_markup={"inline_keyboard": [[{"text": "Cancel", "icon_custom_emoji_id": "5267490665117275176",
                                               "callback_data": f"ustk_price_{_country_cb_token(key)}", "style": "danger"}]]})

    elif data.startswith("ustk_setreq_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        key = _country_from_token(data[len("ustk_setreq_"):])
        user_states[chat_id] = "ustk_set_req"
        temp_data[chat_id] = {"msg_id": msg_id, "country": key}
        current = bot_settings.get("country_settings", {}).get(key, {}).get("num_req", bot_settings.get("num_req", 1))
        edit_message(chat_id, msg_id, render_body_text(
            f"📱 <b>Set NUM/REQ</b>\n\n🌍 <b>Country:</b> {_country_display(key)}\n"
            f"Current: <code>{current}</code>\n\nSend how many numbers per request. Example: <code>3</code>"
        ), reply_markup={"inline_keyboard": [[{"text": "Cancel", "icon_custom_emoji_id": "5267490665117275176",
                                               "callback_data": f"ustk_price_{_country_cb_token(key)}", "style": "danger"}]]})

    elif data.startswith("ustk_clear_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        key = _country_from_token(data[len("ustk_clear_"):])
        settings = bot_settings.setdefault("country_settings", {})
        enabled = settings.get(key, {}).get("enabled", True)
        settings[key] = {"enabled": enabled}
        save_db()
        edit_message(chat_id, msg_id, render_body_text(
            "💰 <b>COUNTRY PRICE / NUM REQUEST</b>\n\nCustom settings cleared."
        ), reply_markup=_country_price_keyboard())
        answer_callback(call["id"], "✅ Custom settings cleared")

    elif data == "ustk_stock_view":
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        edit_message(chat_id, msg_id, render_body_text(_stock_view_text()),
                     reply_markup={"inline_keyboard": [[{"text": "Back", "icon_custom_emoji_id": "5267490665117275176",
                                                        "callback_data": "update_stock", "style": "primary"}]]})

    elif data == "ustk_reset_used":
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        reset_count = 0
        for b in number_batches.values():
            for n in b.get("numbers", []):
                if n.get("used_by") or n.get("shares"):
                    n["used_by"] = []
                    n["shares"] = 0
                    n.pop("to_remove", None)
                    reset_count += 1
        used_numbers_list.clear()
        save_db()
        edit_message(chat_id, msg_id, update_stock_text(), reply_markup=update_stock_keyboard())
        answer_callback(call["id"], f"✅ Reset {reset_count} remaining stock records", show_alert=True)

    elif data == "ustk_delete_country":
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        edit_message(chat_id, msg_id, render_body_text(
            "🗑 <b>DELETE COUNTRY STOCK</b>\n\nSelect a country. This deletes only local uploaded numbers for that country."
        ), reply_markup=_delete_country_keyboard())

    elif data.startswith("ustk_del_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        key = _country_from_token(data[len("ustk_del_"):])
        removed = 0
        for b_id in list(number_batches.keys()):
            if _country_key(number_batches[b_id].get("country")) == key:
                removed += len(number_batches[b_id].get("numbers", []))
                del number_batches[b_id]
        save_db()
        edit_message(chat_id, msg_id, update_stock_text(), reply_markup=update_stock_keyboard())
        answer_callback(call["id"], f"✅ Deleted {removed} local numbers from {_country_display(key)}", show_alert=True)
        ...
        temp_data[chat_id] = {"msg_id": msg_id, "srv": srv}
        cancel_kb = {"inline_keyboard": [[{"text": "Cancel", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "dxa_service_rates", "style": "danger"}]]}
        edit_message(chat_id, msg_id, render_body_text(f"📝 Send new reward rate for <b>{srv}</b> (current: {current} USDT):"), reply_markup=cancel_kb)
        answer_callback(call["id"])
        ...
        edit_message(
            ...
            render_body_text(
                "📣 <b>CHANNEL PODCAST</b>\n\n"
                "এখানে সর্বোচ্চ <b>৪টি Telegram Channel</b> যোগ করতে পারবেন।\n"
                "Number add করার পর <b>New Number Added</b> announcement "
                "এই channel-গুলোতে automatically যাবে.\n\n"
                f"📊 <b>Configured:</b> {len(targets)}/4\n"
                "⚠️ Bot-কে প্রতিটি channel-এ <b>Administrator</b> করে "
                "post করার permission দিন."
            ),
            reply_markup=channel_podcast_keyboard()
        )
        answer_callback(call["id"])
    ...
    elif data == "dxa_add_channel_podcast":
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        targets = bot_settings.get("channel_podcast_targets", [])
        if len(targets) >= 4:
            answer_callback(call["id"], "⚠️ সর্বোচ্চ ৪টি Channel রাখা যাবে!", show_alert=True)
            return
        user_states[chat_id] = "wait_for_channel_podcast_id"
        temp_data[chat_id] = {"msg_id": msg_id}
        edit_message(
            chat_id,
            msg_id,
            render_body_text(
                "📣 <b>ADD CHANNEL PODCAST</b>\n\n"
                "Channel-এর <b>numeric ID</b> অথবা <b>@username</b> পাঠান.\n\n"
                "Examples:\n"
                "• <code>-1001234567890</code>\n"
                "• <code>@MyChannel</code>\n"
                "• <code>https://t.me/MyChannel</code>\n\n"
                "⚠️ Private channel হলে Bot-কে আগে Administrator করুন."
            ),
            reply_markup={
                "inline_keyboard": [[
                    {
    ...
    elif data.startswith("dxa_del_channel_podcast_"):
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        try:
            ...
            answer_callback(call["id"], "❌ Invalid channel index!", show_alert=True)
            return
        ...
        if 0 <= idx < len(targets):
            ...
            save_db()
            removed_id = removed.get("chat_id", removed) if isinstance(removed, dict) else removed
            answer_callback(call["id"], f"✅ Channel removed: {removed_id}", show_alert=True)
        else:
            answer_callback(call["id"], "❌ Channel not found!", show_alert=True)

        edit_message(
            chat_id,
            msg_id,
            render_body_text("📣 <b>CHANNEL PODCAST</b>\n\nManage automatic number announcement channels:"),
            reply_markup=channel_podcast_keyboard()
        )
        return

    elif data == "dxa_otp_group":
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        user_states[chat_id] = "wait_for_otp_group"
        temp_data[chat_id] = {"msg_id": msg_id}
        current = bot_settings.get("private_log_group_id") or "NOT SET"
        cancel_kb = {"inline_keyboard": [[{"text": "Cancel", "callback_data": "dxa_control", "style": "danger"}]]}
        edit_message(chat_id, msg_id, render_body_text(
            "📡 <b>EDIT OTP GROUP</b>\n\n"
            "Send the numeric <b>private group ID</b> where OTP event notifications should be logged.\n\n"
            f"Current: <code>{current}</code>\n\n"
    ...
    elif data == "dxa_set_rand_pass":
        if not is_admin(chat_id):
            answer_callback(call["id"], "🚫 Admin only!", show_alert=True)
            return
        user_states[chat_id] = "wait_for_rand_pass"
        temp_data[chat_id] = {"msg_id": msg_id}
        cur = bot_settings.get("rand_name_pass", "")
        cur_txt = f"\n⚙️ Current: <code>{cur}</code>" if cur else "\n⚙️ Currently not set."
        cancel_kb = {"inline_keyboard": [[{"text": "Cancel", "icon_custom_emoji_id": "5267490665117275176", "callback_data": "dxa_control", "style": "danger"}]]}
        edit_message(chat_id, msg_id, render_body_text(
            f"{PEM['star']} <b>RANDOM NAME — PASS SET</b>\n\n"
            f"📝 যে Password/Text দেখাতে চান তা পাঠান:{cur_txt}\n\n"
            f"<i>এটি Random Name এর সাথে সব user দেখতে পাবে।</i>"
        ), reply_markup=cancel_kb)
        answer_callback(call["id"])
        ...
        key_map = {"min_w": "min_withdraw", "otp_r": "otp_reward", "ref_r": "refer_reward", "cool": "cooldown", "num_req": "num_req", "num_share": "num_share", "sup_link": "support_link", "w_group": "w_group", "w_public": "w_public_channel"}
        if key in key_map:
        ...
        nexus_cnts = set(bot_settings.get("nexus_services", {}).get(service, {}).keys())
        all_countries = local_cnts.union(zenex_cnts).union(stex_cnts).union(voltx_cnts).union(nexus_cnts)
        all_countries = {c for c in all_countries if _country_is_enabled(c)}
        ...
        # সব চারটা provider এর services থেকে service+country খুঁজে বের করো
        all_svc_dicts = [
            bot_settings.get("zenex_services", {}),
            bot_settings.get("stex_services",  {}),
            bot_settings.get("voltx_services", {}),
            bot_settings.get("nexus_services", {}),
        ]
        ...
        if not service:
            ...
            for i in range(len(parts) - 1, 0, -1):
                ...
                nexus_cnts = set(bot_settings.get("nexus_services", {}).get(svc_try, {}).keys())
                if cnt_try in local_cnts or cnt_try in zenex_cnts or cnt_try in stex_cnts or cnt_try in voltx_cnts or cnt_try in nexus_cnts:
        ...
        _n = bot_settings.get("nexus_services", {}).get(service, {}).get(country, [])
        country_ranges = list(dict.fromkeys(_z + _s + _v + _n))  # merge, deduplicate, keep order
        ...
        if bot_settings.get("bulk_auto_approve"):
            ...
            edit_message(chat_id, msg_id, render_body_text(
                ...
                f"📱 <b>Service Name :</b> {service}\n"
                f"🌍 <b>Country Name :</b> {country}\n"
                f"🔢 <b>Amount :</b> 100 numbers\n"
                f"━━━━━━━━━━━━\n"
                f"⌛ 100 Numbers Are Being Fetched. Please Wait..."
            ), reply_markup={"inline_keyboard": kb})
        ...
        admin_msg = (
            ...
            f"👤 <b>Telegram Name :</b> <a href='tg://user?id={chat_id}'>{full_name}</a>\n"
            f"👤 <b>Telegram ID :</b> <code>{chat_id}</code>\n"
            f"📱 <b>Service Name :</b> {service}\n"
            f"🌍 <b>Country Name :</b> {country}\n"
            f"🔢 <b>Amount :</b> 100 Numbers\n\n"
            ...
            for flag_code, flag_data in flags_db.items():
                ...
                if c.upper() == iso or c.upper() == name or c.upper() in name or name in c.upper():
                    if "id" in flag_data:
                        emoji_id = flag_data["id"]
                        break
            _cnt_btns.append({"text": f"{c}", "icon_custom_emoji_id": emoji_id, "callback_data": f"g_c_{service}_{c}", "style": "success"})
        for i in range(0, len(_cnt_btns), 2):
            kb.append(_cnt_btns[i:i+2])
        ...
        def _change_custom(chat_id, query, range_text, msg_id):
            ...
            for _plen in range(min(3, len(query)), 0, -1):
                ...
                if _candidate:
                    ...
                    break
            if _custom_iso and not _country_is_enabled(_custom_iso):
                edit_message(chat_id, msg_id, render_body_text(f"❌ {_country_display(_custom_iso)} is currently OFF!"))
                return
            req_count = _country_num_req(_custom_iso) if _custom_iso else max(1, int(bot_settings.get("num_req", 1)))
            assigned_nums = []
            ...
            for num in assigned_nums:
                ...
                for _, flag_data in flags_db.items():
                    if iso == flag_data.get("iso"):
                        if "id" in flag_data: emoji_id = flag_data["id"]; break
                kb.append([_number_button(num, emoji_id, cc_visible=True)])
            kb.extend(_four_number_control_rows(f"c_custom_{range_text}", "close_msg", bot_settings.get("otp_link", "https://t.me/")))
            ...
            try:
                edit_message(chat_id, msg_id, txt, reply_markup={"inline_keyboard": kb})
                user_active_sessions[chat_id] = {"msg_id": msg_id, "nums": assigned_nums, "service": "Custom", "country": range_text, "reply_markup": {"inline_keyboard": kb}, "cc_visible": True}
            except:
                res = send_message(chat_id, txt, reply_markup={"inline_keyboard": kb})
                new_id = res.get("result", {}).get("message_id")
                if new_id:
                    user_active_sessions[chat_id] = {"msg_id": new_id, "nums": assigned_nums, "service": "Custom", "country": range_text, "reply_markup": {"inline_keyboard": kb}, "cc_visible": True}

        threading.Thread(target=_change_custom, args=(chat_id, query, range_text, msg_id), daemon=True).start()
        return

    elif data == "toggle_cc":
        _toggle_cc_for_session(chat_id, msg_id, call["id"])
        return
        ...
        if data.startswith("c_n_s_"):
            ...
            kb.extend(_four_number_control_rows(f"c_n_s_{query}{srv_ext}", back_cb, bot_settings.get("otp_link", "https://t.me/")))
            
            srvc_label = service_from_cb if service_from_cb else f"+{query}"
            cb_header = render_body_text(
                f"{PEM['ok']} <b>Your Number Taken Successfully</b>\n\n"
                f"🔍 <b>Your Service :</b> {srvc_label}"
            )
        ...
        if not _country_is_enabled(country):
            answer_callback(call["id"], f"❌ {_country_display(country)} is currently OFF.", show_alert=True)
            try: delete_message(chat_id, msg_id)
            except: pass
            return
        ...
        for b_id, b_data in number_batches.items():
            if b_data["service"] == service and _country_key(b_data.get("country")) == _country_key(country):
                for idx, n_obj in enumerate(b_data["numbers"]):
        ...
        if not available_indices:
            voltx_srv_data = _country_map_get(bot_settings.get("voltx_services", {}).get(service, {}), country)
            zenex_srv_data = _country_map_get(bot_settings.get("zenex_services", {}).get(service, {}), country)
            stex_srv_data = _country_map_get(bot_settings.get("stex_services", {}).get(service, {}), country)
            nexus_srv_data = _country_map_get(bot_settings.get("nexus_services", {}).get(service, {}), country)
            ...
            if voltx_srv_data and len(voltx_srv_data) > 0:
                ...
                is_stex = True
            elif nexus_srv_data and len(nexus_srv_data) > 0:
                target_range = random.choice(nexus_srv_data)
                is_nexus = True
            ...
            if target_range:
                ...
                def _show_fetched_numbers(fetched_nums, service, country, msg_id, chat_id, panel_label):
                    ...
                    for num in fetched_nums:
                        ...
                        kb.append([_number_button(num, WAITING_NUMBER_EMOJI_ID, cc_visible=True)])
                    kb.extend(_four_number_control_rows(f"g_c_{service}_{country}", f"g_s_{service}", bot_settings.get("otp_link", "https://t.me/")))
                    first_iso = "XX"
                    if fetched_nums:
                        try: _, first_iso = get_flag_and_code(str(fetched_nums[0]))
                        except Exception: first_iso = "XX"
                    country_name = get_country_name(first_iso)
                    country_flag = get_flag_info_html(first_iso)
                    header_txt = render_body_text(
                        f"🌎 <b>Country: {country_flag} {country_name.upper()} ({first_iso})</b>\n\n"
                        f"⌛ <i>Waiting for OTP</i>"
                    )
                    edit_message(chat_id, msg_id, header_txt, reply_markup={"inline_keyboard": kb})
                    user_active_sessions[chat_id] = {"msg_id": msg_id, "nums": fetched_nums, "reply_markup": {"inline_keyboard": kb}, "cc_visible": True}

                edit_message(chat_id, msg_id, render_body_text("⌛ <i>Number Is Being Assigned Please Wait.</i>"))
                fetched_nums = []
                ...
                if is_voltx:
                    ...
                    nexus_keys = bot_settings.get("nexus_keys", [])
                    if not nexus_keys:
                        answer_callback(call["id"], "❌ Nexus API key configure করা নেই! Admin-কে জানান।", show_alert=True)
                        return
                    if not bot_settings.get("nexus_panel_on", False):
                        answer_callback(call["id"], "❌ Nexus panel এখন বন্ধ আছে! Admin-কে জানান।", show_alert=True)
                        return
                    # service_sid: Nexus API-তে service identifier (e.g. wa, tg, fb)
                    # nexus_services এ range হিসেবে যা দেওয়া আছে সেটাই range, service টা sid
                    service_sid = service.lower().strip()
                    edit_message(chat_id, msg_id, render_body_text("⌛ <i>VIP NUMBER PROVIDE</i>"))
                    while len(fetched_nums) < req_count:
                        num_str, number_id, used_key = _fetch_nexus_parallel(target_range, service_sid, nexus_keys)
                        if not num_str: break
                        fetched_nums.append(num_str)
                        nexus_assigned_numbers[num_str] = chat_id
                        total_assigned_stats += 1
                        if number_id and used_key:
                            threading.Thread(target=poll_nexus_otp, args=(number_id, num_str, chat_id, used_key), daemon=True).start()
                    if not fetched_nums:
                        answer_callback(call["id"], "❌ Nexus number পাওয়া যায়নি! পরে আবার চেষ্টা করুন।", show_alert=True)
                        return
                    save_db()
                    _show_fetched_numbers(fetched_nums, service, country, msg_id, chat_id, "Nexus")
                    return
        ...
        fetched_nums = []
        req_count = _country_num_req(country)
        ...
        kb.extend(_four_number_control_rows(f"c_n_{service}_{country}", f"g_s_{service}", bot_settings.get("otp_link", "https://t.me/")))
        ...
        if chat_id not in temp_data or user_states.get(chat_id) != "withdraw_confirmation":
            answer_callback(call["id"], "❌ Withdrawal session expired. Please try again.", show_alert=True)
            return

        wd = temp_data[chat_id]
        amount = float(wd.get("amount", 0))
        method = wd.get("method", "")
        number = str(wd.get("withdraw_number", "")).strip()
        full_name = wd.get("withdraw_full_name", "User")
        user_bio = wd.get("withdraw_bio", "")
        current_balance = float(get_user(chat_id).get("balance", 0.0))

        if amount <= 0 or not number:
            answer_callback(call["id"], "❌ Invalid withdrawal details.", show_alert=True)
            return
        if amount > current_balance:
            answer_callback(call["id"], "❌ Insufficient balance. Please try again.", show_alert=True)
            return
        ...
        w_admin_msg = f"🎙 <b>New Withdrawal Request</b>\n\n👤 <b>User Name :</b> <a href='tg://user?id={chat_id}'>{html.escape(full_name)}</a>\n💳 <b>Withdrawal Amount :</b> {amount} USDT\n📞 <b>Full Number :</b> <code>{html.escape(number)}</code>\n🏦 <b>Method Buy :</b> {html.escape(method)}\n\n🧾 <b>Request ID :</b> {req_id}\n👨‍⚖️ <b>Processed By Admin</b>"
        w_approve_kb = {"inline_keyboard": [[
        ...
        if OWNER_ID not in notified:
            try:
                send_message(OWNER_ID, render_body_text(w_admin_msg), reply_markup=w_approve_kb)
            except Exception:
                pass

        msg_id_to_edit = wd.get("msg_id", msg_id)
        submitted_text = f"""╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮
   {PEM['ok']}    Withdrawal Request Submitted Done!
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯

🧾 <b>Request ID :</b> <code>{req_id}</code>
💰 <b>Amount :</b> {amount:.4f} USDT
🏦 <b>Method :</b> {html.escape(method)}
📞 <b>Number :</b> <code>{html.escape(number)}</code>
...
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━╯"""
        edit_message(chat_id, msg_id_to_edit, render_body_text(submitted_text), reply_markup={"inline_keyboard": []})
        del user_states[chat_id]
        del temp_data[chat_id]
        answer_callback(call["id"], "✅ Withdrawal request sent to admin!", show_alert=False)

    elif data == "cancel_withdraw_confirm":
        if chat_id not in temp_data or user_states.get(chat_id) != "withdraw_confirmation":
            answer_callback(call["id"], "❌ Withdrawal session expired.", show_alert=True)
            return

        wd = temp_data[chat_id]
        amount = float(wd.get("amount", 0))
        method = str(wd.get("method", ""))
        number = str(wd.get("withdraw_number", ""))
        msg_id_to_edit = wd.get("msg_id", msg_id)
        cancel_text = f"""╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮
   {PEM['no']}    Withdrawal Cancelled
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯
...
📌 No Withdrawal Request Was Sent To Admin.
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━╯"""
        # Keep the same message in place; only remove the action buttons.
        edit_message(chat_id, msg_id_to_edit, render_body_text(cancel_text), reply_markup={"inline_keyboard": []})
        del user_states[chat_id]
        del temp_data[chat_id]
        answer_callback(call["id"], "❌ Withdrawal cancelled.", show_alert=False)
        ...
        if req_id in pending_withdrawals:
            ...
            if action == "APPROVE" and len(num) >= 7:
                masked_num = f"{num[:4]}ROMAN{num[-3:]}"
            else:
                masked_num = num
            ...
            if action == "REJECT":
                ...
                send_message(u_id, render_body_text(f"""╭━━━━━━━━━━━━━━━━━━━━━━━╮
        {PEM['ok']} Withdrawal Successful Done
╰━━━━━━━━━━━━━━━━━━━━━━━╯
...
╰━━━━━━━━━━━━━━━━━━━━━━━╯"""))
            ...
            if db:
                try:
                    update_data = {"status": "approved" if action == "APPROVE" else "rejected"}
                    if action == "APPROVE":
                        update_data["tx_hash"] = _generate_public_tx_hash(req_data)
                    db.collection('withdrawals').document(req_id).update(update_data)
                except: pass

            if action == "APPROVE":
                try:
                    published, publish_error = _publish_approved_withdrawal(req_data)
                    if published:
                        print(f"✅ Public withdrawal published: {req_id}")
                    else:
                        print(f"⚠️ Public withdrawal publish failed: {req_id} | {publish_error}")
                        # Tell the approving admin exactly why publication failed.
                        admin_notice = (
                            f"⚠️ <b>Public Withdrawal Publication Failed</b>\n\n"
                            f"🧾 Request ID: <code>{req_id}</code>\n"
                            f"📣 Public Target: <code>{html.escape(str(bot_settings.get('w_public_channel', '')))}</code>\n"
                            f"❌ Error: <code>{html.escape(str(publish_error))}</code>"
                        )
                        send_message(user_id_clicked, render_body_text(admin_notice))
                except Exception as e:
                    print(f"⚠️ Public withdrawal publish error: {e}")
                    try:
                        send_message(user_id_clicked, render_body_text(
                            f"⚠️ <b>Public Withdrawal Publication Failed</b>\n\n"
                            f"🧾 Request ID: <code>{req_id}</code>\n"
        ...
        new_admin_txt = (
            ...
            f"👤 <b>User Name :</b> <a href='tg://user?id={u_id}'>{full_name}</a>\n" 
        ...
        if action == "REJECT":
            send_message(u_id, render_body_text(
                ...
                f"━━━━━━━━━━━━━━━━━\n"
                f"🧾 <b>Request ID :</b> <code>{req_id}</code>\n"
                f"📱 <b>Service Name :</b> {service} / {country}\n\n"
                f"Your Bulk Request Was Rejected By The Admin."
            ))
        else:
            ...
            send_message(u_id, render_body_text(
                ...
                f"🧾 <b>Request ID :</b> <code>{req_id}</code>\n"
                f"📱 <b>Service Name :</b> {service} / {country}\n\n"
                f"⌛ Processing 100 Numbers. Please Wait..."
            ))
            ...
            def _do_approved_bulk():
                ...
                # Local stock first
                for b_id, b_data in number_batches.items():
                    if b_data.get("service") == service and _country_key(b_data.get("country")) == _country_key(country):
                ...
                send_message(u_id, render_body_text(
                    ...
                    f"─────────────────────\n"
                    f"✅ Total : <b>{len(final_nums)}</b> Numbers\n"
                    f"📄 Download The TXT File Above\n"
                    f"🔔 Some Number A OTP In Fact <b>Get OTP</b> Click"
...
def _direct_number_session_is_active(owner_id, num_str, assignment_map):
    """Return True only while the provider assignment and user session still match."""
    clean = _clean_number_for_ui(num_str)
    if not clean:
        return False
    if assignment_map.get(clean) != owner_id and assignment_map.get("+" + clean) != owner_id:
        return False
    session = user_active_sessions.get(owner_id)
    if not session:
        return False
    session_nums = {_clean_number_for_ui(n) for n in session.get("nums", [])}
    return clean in session_nums


def poll_zenex_otp(number_id, num_str, owner_id, api_key):
    headers = {"mapikey": api_key, "Content-Type": "application/json"}
    for _ in range(150):
        if not _direct_number_session_is_active(owner_id, num_str, zenex_assigned_numbers):
            break
        try:
...
def poll_nexus_otp(number_id, num_str, owner_id, api_key):
    """Nexus-X number এর OTP poll করে — GET /api/v1/numbers/{id}
    Status 'success' এবং otps non-empty হলে user-কে OTP পাঠায়।"""
    headers = {
        "Authorization": f"Bearer {api_key}",
        "Content-Type": "application/json"
    }
    for _ in range(150):  # ~10 মিনিট
        if not _direct_number_session_is_active(owner_id, num_str, nexus_assigned_numbers):
            break  # ~4s interval × 150
        try:
            res = requests.get(
                f"https://v2.nexus-x.site/api/v1/numbers/{number_id}",
            ...
            if status in ("failed", "expired"):
                break
            otps = data.get("otps", [])
            if status == "success" and otps:
                otp_item = otps[0]
                msg_text = (
                    otp_item.get("body") or otp_item.get("text") or
                    otp_item.get("full_text") or otp_item.get("console") or ""
                ).strip()
                sender = otp_item.get("sender", "")
                service_raw = (
                    data.get("service") or data.get("access") or data.get("sid") or ""
                )
                otp = extract_otp_code(msg_text)
                if not otp:
                    break
                # nexus_panel_listener এর মতো একই unique_id format ব্যবহার করি
                # যাতে listener আগে fire করলে poll block হয়, বা poll আগে হলে listener block হয়
                otp_item_id = otp_item.get("id", "")
                num_clean = str(num_str).replace("+", "").replace(" ", "").replace("-", "").strip()
                unique_id = f"NEXUS_{num_clean}_{otp}_{otp_item_id}"
                if not _safe_add_otp(unique_id):
                    break
                char, iso = get_flag_and_code(num_str)
                app_full_name, prem_app_html = get_service_info_html(sender or service_raw, msg_text)
                global recent_traffic
                current_time = time.time()
                recent_traffic = [t for t in recent_traffic if current_time - t.get("time", 0) <= 3600]
                recent_traffic.append({"service": app_full_name, "iso": iso, "flag": char, "number": num_str, "time": current_time})
                ...
                try:
                    ...
                    if resp_data.get("meta", {}).get("code") == 200 and "data" in resp_data and "otps" in resp_data["data"]:
                        for item in resp_data["data"]["otps"]:
                            ...
                            owners = list(set(owners))
                            if not owners:
                                print(f"📡 [Voltx] {clean_api_num} → OTP={otp} | No bot user match found (group only)")
                                if bot_settings.get("no_match_alert_on", True):
                                    try:
                                        _all_admins = list(bot_settings.get("admins", []))
                                        if OWNER_ID not in _all_admins:
                                        ...
                                        _dbg_msg = render_body_text(
                                            ...
                                            f"📞 <b>Number:</b> <code>+{clean_api_num}</code>\n"
                                            f"🔑 <b>OTP:</b> <code>{otp}</code>\n"
                                            f"📊 <b>Voltx Assigned:</b> {len(voltx_assigned_numbers)} | "
                                            f"<b>Sessions:</b> {len(user_active_sessions)}"
                                        )
                                        for _adm in _all_admins:
                                            try: send_message(_adm, _dbg_msg)
                                ...
                                print(f"📡 [Voltx] {clean_api_num} → OTP={otp} | Sending to {len(owners)} users")
                            ...
                            for owner_id in owners:
                                try:
                                    ...
                                    print(f"⚠️ [Voltx] Failed to send to user {owner_id}: {e}")
                except: pass
        except: pass
        time.sleep(1)
            ...
            for api_key in zenex_keys:
                try:
                    ...
                    for item in items:
                        ...
                        owners = list(set(owners))
                        if not owners:
                            print(f"📡 [Zenex] {clean_api_num} → OTP={otp} | No bot user match found (group only)")
                            if bot_settings.get("no_match_alert_on", True):
                                try:
                                    _all_admins = list(bot_settings.get("admins", []))
                                    if OWNER_ID not in _all_admins:
                                    ...
                                    _dbg_msg = render_body_text(
                                        ...
                                        f"📞 <b>Number:</b> <code>+{clean_api_num}</code>\n"
                                        f"🔑 <b>OTP:</b> <code>{otp}</code>\n"
                                        f"📊 <b>Zenex Assigned:</b> {len(zenex_assigned_numbers)} | "
                                        f"<b>Sessions:</b> {len(user_active_sessions)}"
                                    )
                                    for _adm in _all_admins:
                                        try: send_message(_adm, _dbg_msg)
                            ...
                            print(f"📡 [Zenex] {clean_api_num} → OTP={otp} | Sending to {len(owners)} users")
                        ...
                        for owner_id in owners:
                            try:
                                ...
                                print(f"⚠️ [Zenex] Failed to send to user {owner_id}: {e}")
                except: pass
        except: pass
        time.sleep(1)
...
def shark_panel_listener():
    ...
    while True:
        try:
            ...
            for token in tokens:
                try:
                    # FIX: dt1 বাদ — same-second OTP miss ঠেকাতে, processed_otps দিয়ে dedup
                    ...
                    for item in items:
                        ...
                        owners = list(set(owners))
                        if not owners:
                            print(f"🦈 [Shark] {clean_api_num} → OTP={otp} | No bot user match found (group only)")
                            if bot_settings.get("no_match_alert_on", True):
                                try:
                                    _all_admins = list(bot_settings.get("admins", []))
                                    if OWNER_ID not in _all_admins:
                                    ...
                                    _dbg_msg = render_body_text(
                                        ...
                                        f"📊 <b>Batch Assigned:</b> {len(batch_assigned_numbers)} | "
                                        f"<b>Sessions:</b> {len(user_active_sessions)}\n\n"
                                        "→ Admin Panel → Shark Panel → 🔍 Live API Test"
                                    )
                                    for _adm in _all_admins:
                                        try: send_message(_adm, _dbg_msg)
                                        except: pass
                            ...
                            print(f"🦈 [Shark] {clean_api_num} → OTP={otp} | Sending to {len(owners)} users")
                ...
                reward if reward_on else 0, reward_on, lang=lang)
                            except Exception as e:
                                print(f"⚠️ [Shark] Failed to send to user {owner_id}: {e}")

                        # This item was successfully processed — advance dt
                        if item_dt and (max_processed_dt is None or item_dt > max_processed_dt):
                            max_processed_dt = item_dt

                    # BUG FIX: Update last_seen_dt at the end of the loop — so dt
                    # only advances to records that were actually processed
                    if max_processed_dt:
        ...
        time.sleep(5)  # 5s poll interval — fast OTP delivery
            ...
            for token in tokens:
                try:
                    ...
                    for item in items:
                        ...
                        owners = list(set(owners))
                        if not owners:
                            print(f"🌐 [CR] {clean_api_num} → OTP={otp} | No bot user match found (group only)")
                            if bot_settings.get("no_match_alert_on", True):
                                try:
                                    _all_admins = list(bot_settings.get("admins", []))
                                    if OWNER_ID not in _all_admins:
                            ...
                            print(f"🌐 [CR] {clean_api_num} → OTP={otp} | Sending to {len(owners)} users")
                ...
                reward if reward_on else 0, reward_on, lang=lang)
                                ...
                                print(f"⚠️ [CR] Failed to send to user {owner_id}: {e}")
...
def nexus_panel_listener():
    """Nexus-X REST API (Bearer token) থেকে OTP poll করে।"""
    global processed_otps, recent_traffic, nexus_assigned_numbers
    print("🔷 Nexus-X Panel Listener started!")
    _fw_warn_logged = False
    seen_otp_ids = set()  # inbox item id বা (number+body) দিয়ে dedup
    ...
    while True:
        try:
            ...
            fw_groups = bot_settings.get("fw_groups", [])
            if not fw_groups and not _fw_warn_logged:
                print("⚠️ [Nexus-X] fw_groups ফাঁকা! Admin panel থেকে OTP forward group যোগ করুন।")
                _fw_warn_logged = True
            elif fw_groups:
                _fw_warn_logged = False
            ...
            for api_key in keys:
                try:
                    ...
                    res = requests.get(
                        "https://v2.nexus-x.site/api/v1/inbox",
                        headers=headers,
                        timeout=12
                    )

                    if res.status_code == 401:
                        print(f"⚠️ [Nexus-X] Key ...{api_key[-6:]}: Unauthorized — key invalid বা expired")
                        time.sleep(30)
                        continue

                    if res.status_code != 200:
                        print(f"⚠️ [Nexus-X] HTTP {res.status_code} for key ...{api_key[-6:]}")
                        time.sleep(5)
                        continue
                    ...
                    try:
                        ...
                        print(f"⚠️ [Nexus-X] JSON parse failed: {je} | body={raw_text[:120]}")
                        time.sleep(10)
                        continue

                    # inbox returns list directly or nested in "data"/"items"
                    if isinstance(data_resp, list):
                        items = data_resp
                    elif isinstance(data_resp, dict):
                        items = data_resp.get("data", data_resp.get("items", data_resp.get("otps", [])))
                    else:
                        items = []
                    ...
                    for item in items:
                        # number field aliases
                        num_raw = (item.get("number") or item.get("full_number") or
                                   item.get("no_plus_number") or item.get("national_number") or "")
                        num = str(num_raw).replace("+", "").replace(" ", "").replace("-", "").strip()

                        # message text aliases
                        msg_text = (item.get("body") or item.get("text") or
                                    item.get("full_text") or item.get("console") or "").strip()

                        # service aliases
                        service_raw = (item.get("service") or item.get("access") or
                                       item.get("sid") or "")
                        sender = item.get("sender", "")

                        # unique dedup key
                        item_id = item.get("id", "")
                        dedup_key = f"NEXUS_{item_id}_{num}" if item_id else f"NEXUS_{num}_{msg_text[:30]}"

                        if not num or not msg_text:
                            continue

                        if dedup_key in seen_otp_ids:
                            continue

                        otp = extract_otp_code(msg_text)
                        if not otp:
                            seen_otp_ids.add(dedup_key)
                            continue

                        unique_id = f"NEXUS_{num}_{otp}_{item_id}"
                        if not _safe_add_otp(unique_id):
                            seen_otp_ids.add(dedup_key)
                            continue
                        ...
                        app_full_name, prem_app_html = get_service_info_html(
                            sender or service_raw, msg_text
                        )
                        ...
                        print(f"🔷 [Nexus-X] নতুন OTP পেয়েছি → num={display_num} | service={app_full_name} | otp={otp}")

                        # Group forward
                        try:
                            if fw_groups:
                                _fw_send_otp(fw_groups, app_full_name, prem_app_html, char, iso, display_num, lang, otp)
                                print(f"🔷 [Nexus-X] Group-এ forward করা হয়েছে ({len(fw_groups)} group)")
                        except Exception as e:
                            print(f"⚠️ [Nexus-X] group forward failed: {e}")

                        # Active user matching
                        clean_api_num = num
                        owners = []
                        ...
                        owners = list(set(owners))
                        if not owners:
                            print(f"🔷 [Nexus-X] {clean_api_num} → OTP={otp} | কোনো bot user match হয়নি (group only)")
                        else:
                            print(f"🔷 [Nexus-X] {clean_api_num} → OTP={otp} | {len(owners)} জন user-কে পাঠাচ্ছি")
                ...
                reward if reward_on else 0, reward_on, lang=lang)
                                ...
                                print(f"⚠️ [Nexus-X] user {owner_id}-কে পাঠাতে ব্যর্থ: {e}")

                except Exception as e:
                    print(f"⚠️ [Nexus-X] key poll failed ...{api_key[-6:] if len(api_key) >= 6 else api_key}: {e}")

        except Exception as e:
            print(f"⚠️ nexus_panel_listener crashed: {e}")
...
def main():
    ...
    threading.Thread(target=nexus_panel_listener, daemon=True).start()
    print("📡 Background APIs & Global SMS Listener + KeepAlive + Shark Panel + CR Panel + Flex Panel + Nexus-X Panel Started!")
